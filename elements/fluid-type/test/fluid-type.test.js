...
describe('Instantiation Test', () => {
    it('fluid-type instantiates', async () => {
      const el = await fixture(html` <fluid-type title="test-title"></fluid-type> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('fluid-type passes accessibility negation', async () => {
        const el = await fixture(html`<fluid-type aria-labelledby="fluid-type"></fluid-type>`);
