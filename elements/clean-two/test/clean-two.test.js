...
describe('Instantiation Test', () => {
    it('clean-two instantiates', async () => {
      const el = await fixture(html` <clean-two title="test-title"></clean-two> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('clean-two passes accessibility negation', async () => {
        const el = await fixture(html`<clean-two aria-labelledby="clean-two"></clean-two>`);
