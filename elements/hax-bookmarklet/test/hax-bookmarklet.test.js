...
describe('Instantiation Test', () => {
    it('hax-bookmarklet instantiates', async () => {
      const el = await fixture(html` <hax-bookmarklet title="test-title"></hax-bookmarklet> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('hax-bookmarklet passes accessibility negation', async () => {
        const el = await fixture(html`<hax-bookmarklet aria-labelledby="hax-bookmarklet"></hax-bookmarklet>`);
