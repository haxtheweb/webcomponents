...
describe('Instantiation Test', () => {
    it('a11y-menu-button instantiates', async () => {
      const el = await fixture(html` <a11y-menu-button title="test-title"></a11y-menu-button> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('a11y-menu-button passes accessibility negation', async () => {
        const el = await fixture(html`<a11y-menu-button aria-labelledby="a11y-menu-button"></a11y-menu-button>`);
