...
import '../src/lrndesign-timeline.js';
...
describe('Instantiation Test', () => {
    it('lrndesign-timeline instantiates', async () => {
      const el = await fixture(html` <lrndesign-timeline title="test-title"></lrndesign-timeline> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrndesign-timeline passes accessibility negation', async () => {
        const el = await fixture(html`<lrndesign-timeline aria-labelledby="lrndesign-timeline"></lrndesign-timeline>`);
