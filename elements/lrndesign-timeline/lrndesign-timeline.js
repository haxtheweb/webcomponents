  ...
  static get template() {
    return html`
      <style>
        ...
        :host([timeline-size*="s"]) .event {
          border-bottom: 1px solid var(--lrndesign-timeline-background);
        }
        :host([timeline-size*="s"]) .event:first-of-type {
        ...
        :host(:not([timeline-size*="s"])) .event[has-media] .heading h2 {
        ...
        :host(:not([timeline-size*="s"])) .media-outer {
          ...
          width: 50%;
          height: 300px;
          border-left: 3px solid var(--lrndesign-timeline-border);
        }
        ...
        :host(:not([timeline-size*="s"]))
          ...
          border-left: 25px solid var(--lrndesign-timeline-header-accent);
          opacity: 1;
        }
        :host(:not([timeline-size*="s"])) .media {
          ...
          opacity: 0;
          transition: opacity 0.8s delay 0.2s;
        }
