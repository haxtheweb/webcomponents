...
import '../src/hax-body-behaviors.js';
...
describe('Instantiation Test', () => {
    it('hax-body-behaviors instantiates', async () => {
      const el = await fixture(html` <hax-body-behaviors title="test-title"></hax-body-behaviors> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('hax-body-behaviors passes accessibility negation', async () => {
        const el = await fixture(html`<hax-body-behaviors aria-labelledby="hax-body-behaviors"></hax-body-behaviors>`);
