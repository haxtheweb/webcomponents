...
import '../src/lazy-import-discover.js';
...
describe('Instantiation Test', () => {
    it('lazy-import-discover instantiates', async () => {
      const el = await fixture(html` <lazy-import-discover title="test-title"></lazy-import-discover> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lazy-import-discover passes accessibility negation', async () => {
        const el = await fixture(html`<lazy-import-discover aria-labelledby="lazy-import-discover"></lazy-import-discover>`);
