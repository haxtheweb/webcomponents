...
describe('Instantiation Test', () => {
    it('barcode-reader instantiates', async () => {
      const el = await fixture(html` <barcode-reader title="test-title"></barcode-reader> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('barcode-reader passes accessibility negation', async () => {
        const el = await fixture(html`<barcode-reader aria-labelledby="barcode-reader"></barcode-reader>`);
