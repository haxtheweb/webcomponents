...
describe('Instantiation Test', () => {
    it('paper-audio-player instantiates', async () => {
      const el = await fixture(html` <paper-audio-player title="test-title"></paper-audio-player> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('paper-audio-player passes accessibility negation', async () => {
        const el = await fixture(html`<paper-audio-player aria-labelledby="paper-audio-player"></paper-audio-player>`);
