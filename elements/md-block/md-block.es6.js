 ...
 */import{html,PolymerElement}from"./node_modules/@polymer/polymer/polymer-element.js";import{HAXWiring}from"./node_modules/@lrnwebcomponents/hax-body-behaviors/lib/HAXWiring.js";import"./node_modules/@polymer/polymer/lib/elements/dom-if.js";/**
 * `md-block`
 * `a markdown block`
 *
...
static get properties(){let props={source:{name:"source",type:String},hasSource:{name:"hasSource",type:Boolean,computed:"_calculateHasSource(source)"},markdown:{name:"markdown",type:String}};if(super.properties){props=Object.assign(props,super.properties)}return props}constructor(){super();import("./node_modules/@polymer/marked-element/marked-element.js")}/**
