...
describe('Instantiation Test', () => {
    it('random-image instantiates', async () => {
      const el = await fixture(html` <random-image title="test-title"></random-image> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('random-image passes accessibility negation', async () => {
        const el = await fixture(html`<random-image aria-labelledby="random-image"></random-image>`);
