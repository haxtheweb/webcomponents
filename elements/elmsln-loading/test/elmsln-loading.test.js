...
describe('Instantiation Test', () => {
    it('elmsln-loading instantiates', async () => {
      const el = await fixture(html` <elmsln-loading title="test-title"></elmsln-loading> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('elmsln-loading passes accessibility negation', async () => {
        const el = await fixture(html`<elmsln-loading aria-labelledby="elmsln-loading"></elmsln-loading>`);
