...
require.register("side-comments/js/main.js", function(
  exports,
  require,
  module
) {
  ...
  function SideComments(el, currentUser, existingComments) {
    ...
    this.eventPipe.on(
      "sectionDeselected",
      _.bind(this.sectionDeselected, this)
    );
    ...
    this.eventPipe.on(
      "addCommentAttempted",
      _.bind(this.addCommentAttempted, this)
    );
  ...
  SideComments.prototype.initialize = function(existingComments) {
    _.each(
      this.$el.find(".commentable-section"),
      function(section) {
        var $section = $(section);
  ...
  SideComments.prototype.bodyClick = function(event) {
    ...
    if (
      $target.closest(".side-comment").length < 1 &&
...
require.register("side-comments/js/section.js", function(
  exports,
  require,
  module
) {
  ...
  function Section(eventPipe, $el, currentUser, comments) {
    ...
    this.$el.on(
      this.clickEventName,
      ".side-comment .marker",
      _.bind(this.markerClick, this)
    );
    this.$el.on(
      this.clickEventName,
      ".side-comment .add-comment",
      _.bind(this.addCommentClick, this)
    );
    this.$el.on(
      this.clickEventName,
      ".side-comment .post",
      _.bind(this.postCommentClick, this)
    );
    this.$el.on(
      this.clickEventName,
      ".side-comment .cancel",
      _.bind(this.cancelCommentClick, this)
    );
    this.$el.on(
      this.clickEventName,
      ".side-comment .delete",
      _.bind(this.deleteCommentClick, this)
    );
    this.render();
  }
  ...
  Section.prototype.removeComment = function(commentId) {
    ...
    this.$el
      .find('.side-comment .comments li[data-comment-id="' + commentId + '"]')
      .remove();
    this.updateCommentCount();
...
require.register("side-comments/js/vendor/lodash-custom.js", function(
  exports,
  require,
  module
) {
  ...
  (function() {
    ...
    var nonEnumProps = {};
    nonEnumProps[arrayClass] = nonEnumProps[dateClass] = nonEnumProps[
      numberClass
    ] = {
      constructor: true,
      toLocaleString: true,
    ...
    nonEnumProps[errorClass] = nonEnumProps[funcClass] = nonEnumProps[
      regexpClass
    ...
    (function() {
       ...
       */
      support.argsObject =
        arguments.constructor == Object && !(arguments instanceof Array);
    ...
    function baseIsEqual(a, b, callback, isWhere, stackA, stackB) {
      ...
      if (!isArr) {
        ...
        if (
          className != objectClass ||
          (!support.nodeClass && (isNode(a) || isNode(b)))
        ) {
          return false;
        }
        // in older versions of Opera, `arguments` objects have `Array` constructors
        var ctorA =
            !support.argsObject && isArguments(a) ? Object : a.constructor,
          ctorB =
            !support.argsObject && isArguments(b) ? Object : b.constructor;
...
require.register("side-comments/js/helpers/mobile-check.js", function(
  exports,
  require,
  module
) {
...
require.register("side-comments/templates/section.html", function(
  exports,
  require,
  module
) {
...
require.register("side-comments/templates/comment.html", function(
  exports,
  require,
  module
) {
...
require.alias(
  ...
  "side-comments/deps/emitter/index.js"
);
