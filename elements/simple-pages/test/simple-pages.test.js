...
describe('Instantiation Test', () => {
    it('simple-pages instantiates', async () => {
      const el = await fixture(html` <simple-pages title="test-title"></simple-pages> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-pages passes accessibility negation', async () => {
        const el = await fixture(html`<simple-pages aria-labelledby="simple-pages"></simple-pages>`);
