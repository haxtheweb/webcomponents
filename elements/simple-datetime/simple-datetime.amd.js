...
if(unix){timestamp=1e3*timestamp}return new Date(timestamp).format(format)}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_091e4da0ab1311e9804a0b22b84004a8())}},{key:"tag",get:function get(){return"simple-datetime"}},{key:"properties",get:function get(){return{/**
