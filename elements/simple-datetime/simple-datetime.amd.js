define(["exports","./node_modules/@polymer/polymer/polymer-element.js","./lib/date.format.js"],function(_exports,_polymerElement,_dateFormat){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.SimpleDatetime=void 0;function _templateObject_5f6cfd506d6a11e99c9aa3cf65b431fd(){var data=babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: block;\n        font-size: 14px;\n        color: #b3b3b1;\n        line-height: 30px;\n      }\n    </style>\n    <time datetime$=\"[[date]]\">[[date]]</time>"]);_templateObject_5f6cfd506d6a11e99c9aa3cf65b431fd=function _templateObject_5f6cfd506d6a11e99c9aa3cf65b431fd(){return data};return data}/**
 * `simple-datetime`
...
if(unix){timestamp=1e3*timestamp}return new Date(timestamp).format(format)}}],[{key:"template",get:function get(){return(0,_polymerElement.html)(_templateObject_5f6cfd506d6a11e99c9aa3cf65b431fd())}},{key:"tag",get:function get(){return"simple-datetime"}},{key:"properties",get:function get(){return{/**
