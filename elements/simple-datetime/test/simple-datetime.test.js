...
describe('Instantiation Test', () => {
    it('simple-datetime instantiates', async () => {
      const el = await fixture(html` <simple-datetime title="test-title"></simple-datetime> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-datetime passes accessibility negation', async () => {
        const el = await fixture(html`<simple-datetime aria-labelledby="simple-datetime"></simple-datetime>`);
