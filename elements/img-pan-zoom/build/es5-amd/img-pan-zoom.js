define([
  ...
  function _templateObject_fdecad90f32b11e8932fc7ecdeb1dd6f() {
    ...
    _templateObject_fdecad90f32b11e8932fc7ecdeb1dd6f = function _templateObject_fdecad90f32b11e8932fc7ecdeb1dd6f() {
      return data;
    };
    return data;
  }
  var ImgPanZoom = (0, _polymerLegacy.Polymer)({
    _template: (0, _polymerLegacy.html)(
      _templateObject_fdecad90f32b11e8932fc7ecdeb1dd6f()
    ),
    is: "img-pan-zoom",
    properties: {
      src: { type: String },
      dzi: { type: Boolean, value: !1 },
      fadeIn: { type: Boolean, value: !0 },
      loading: { type: Boolean, readonly: !0, notify: !0 },
      hideSpinner: { type: Boolean, value: !1 },
      loaded: {
        type: Boolean,
        readonly: !0,
        notify: !0,
      ...
      showNavigationControl: { type: Boolean, value: !1 },
      showNavigator: { type: Boolean, value: !1 },
      zoomPerClick: { type: Number, value: 2 },
      zoomPerScroll: { type: Number, value: 1.2 },
      animationTime: { type: Number, value: 1.2 },
      navPrevNextWrap: { type: Boolean, value: !1 },
      showRotationControl: { type: Boolean, value: !1 },
      minZoomImageRatio: { type: Number, value: 1 },
      maxZoomPixelRatio: { type: Number, value: 1.1 },
      constrainDuringPan: { type: Boolean, value: !1 },
    ...
    created: function created() {
      var name = "openseadragon",
        ...
        location = "".concat(
          basePath,
          "lib/openseadragon/build/openseadragon/openseadragon.js"
        );
    ...
    _loadedChanged: function _loadedChanged() {
      if (this.loaded) {
        if (!this.init) {
          this._initOpenSeadragon();
        } else {
    ...
    _addImage: function _addImage() {
      this.viewer.addSimpleImage({ url: this.src, index: 0, replace: !0 });
    },
    _addTiledImage: function _addTiledImage() {
