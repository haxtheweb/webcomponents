...
describe('Instantiation Test', () => {
    it('top-alert instantiates', async () => {
      const el = await fixture(html` <top-alert title="test-title"></top-alert> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('top-alert passes accessibility negation', async () => {
        const el = await fixture(html`<top-alert aria-labelledby="top-alert"></top-alert>`);
