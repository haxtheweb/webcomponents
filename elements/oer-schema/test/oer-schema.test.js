...
describe('Instantiation Test', () => {
    it('oer-schema instantiates', async () => {
      const el = await fixture(html` <oer-schema title="test-title"></oer-schema> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('oer-schema passes accessibility negation', async () => {
        const el = await fixture(html`<oer-schema aria-labelledby="oer-schema"></oer-schema>`);
