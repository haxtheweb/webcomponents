...
describe('Instantiation Test', () => {
    it('shadow-style instantiates', async () => {
      const el = await fixture(html` <shadow-style title="test-title"></shadow-style> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('shadow-style passes accessibility negation', async () => {
        const el = await fixture(html`<shadow-style aria-labelledby="shadow-style"></shadow-style>`);
