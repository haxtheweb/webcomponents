...
describe('Instantiation Test', () => {
    it('pdf-element instantiates', async () => {
      const el = await fixture(html` <pdf-element title="test-title"></pdf-element> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('pdf-element passes accessibility negation', async () => {
        const el = await fixture(html`<pdf-element aria-labelledby="pdf-element"></pdf-element>`);
