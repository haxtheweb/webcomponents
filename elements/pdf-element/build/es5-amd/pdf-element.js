define([
  ...
  function _templateObject_e6624d40f32d11e894d2917f538f4587() {
    ...
    _templateObject_e6624d40f32d11e894d2917f538f4587 = function _templateObject_e6624d40f32d11e894d2917f538f4587() {
      return data;
    };
    return data;
  }
  var PdfElement = (0, _polymerLegacy.Polymer)({
    _template: (0, _polymerLegacy.html)(
      _templateObject_e6624d40f32d11e894d2917f538f4587()
    ),
    is: "pdf-element",
    ...
    attached: function attached() {
      ...
      var props = {
        ...
        gizmo: {
          ...
          handles: [
            { type: "pdf", url: "src", source: "src" },
            { type: "document", url: "src", source: "src" }
          ],
    ...
    attributeChanged: function attributeChanged(name, type) {
      if ("src" === name) {
        if ("undefined" == typeof this.instance) this._initializeReader();
        else {
          this.loadPDF();
          this.changedSideBar = !0;
          this.fromChange = !0;
          this.sideBar();
        }
      } else if ("fitWidth" === name) {
        this._setFitWidth();
      }
    },
    _initializeReader: function _initializeReader() {
      this.instance = new Reader(this);
      if (null != this.src) this.fileName = this.src.split("/").pop();
      this.currentPage = 1;
    },
    _setFitWidth: function _setFitWidth() {
      this.instance.setFitWidth(this.fitWidth);
    },
    zoomInOut: function zoomInOut(step) {
      if (2 <= this.instance.currentZoomVal) {
        this.instance.currentZoomVal = 2;
      } else if (0.1 >= this.instance.currentZoomVal) {
    ...
    pageNumSearch: function pageNumSearch() {
    ...
    sideBarClick: function sideBarClick(page, currentInstance, currentThis) {
      var parsedFileName = currentThis.src.split("/").pop(),
        self = currentInstance;
      currentThis.sidebarOpen = !0;
    ...
    sideBar: function sideBar() {
      if (this.instance.pdfExists) {
        if (!this.fromChange) {
          ...
          if ("25%" == this.$.main.style.marginLeft) {
            this.sidebarOpen = !1;
            this.instance.setViewportPos(!1);
            ...
            this.instance.setViewportPos(!0);
          }
        }
        this.fromChange = !1;
        this.instance.sidebarSetup(this);
        this.changedSideBar = !1;
      }
    },
