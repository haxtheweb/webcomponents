...
import{html,PolymerElement}from"./node_modules/@polymer/polymer/polymer-element.js";// we use this to help speed up time to first paint but it's not required
import{afterNextRender}from"./node_modules/@polymer/polymer/lib/utils/render-status.js";// this is required for any HAXcms theme unless you directly implement what this superClass does
import{HAXCMSTheme}from"./node_modules/@lrnwebcomponents/haxcms-elements/lib/core/HAXCMSThemeWiring.js";// our store implements Mobx and ensures that we maintain state across the application
import{store}from"./node_modules/@lrnwebcomponents/haxcms-elements/lib/core/haxcms-site-store.js";// While not needing to directly implement mobx classes this can let you do more advanced
// integrations with the store and listening for updates to properties elsewhere in the application
import{autorun,toJS}from"./node_modules/mobx/lib/mobx.module.js";/**
...
import("./node_modules/@lrnwebcomponents/haxcms-elements/lib/ui-components/navigation/site-top-menu.js");import("./node_modules/@lrnwebcomponents/haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js");import("./node_modules/@lrnwebcomponents/haxcms-elements/lib/ui-components/layout/site-modal.js");// create a blank array to store mobx reactions
...
afterNextRender(this,function(){import("./node_modules/@lrnwebcomponents/haxcms-elements/lib/ui-components/navigation/site-menu-button.js");import("./node_modules/@lrnwebcomponents/haxcms-elements/lib/ui-components/site/site-search.js")})}/**
