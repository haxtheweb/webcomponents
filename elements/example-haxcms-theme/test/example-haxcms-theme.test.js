...
import '../src/example-haxcms-theme.js';
...
describe('Instantiation Test', () => {
    it('example-haxcms-theme instantiates', async () => {
      const el = await fixture(html` <example-haxcms-theme title="test-title"></example-haxcms-theme> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('example-haxcms-theme passes accessibility negation', async () => {
        const el = await fixture(html`<example-haxcms-theme aria-labelledby="example-haxcms-theme"></example-haxcms-theme>`);
