...
describe('Instantiation Test', () => {
    it('simple-toast instantiates', async () => {
      const el = await fixture(html` <simple-toast title="test-title"></simple-toast> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-toast passes accessibility negation', async () => {
        const el = await fixture(html`<simple-toast aria-labelledby="simple-toast"></simple-toast>`);
