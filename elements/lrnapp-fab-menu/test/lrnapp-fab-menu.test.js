...
describe('Instantiation Test', () => {
    it('lrnapp-fab-menu instantiates', async () => {
      const el = await fixture(html` <lrnapp-fab-menu title="test-title"></lrnapp-fab-menu> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrnapp-fab-menu passes accessibility negation', async () => {
        const el = await fixture(html`<lrnapp-fab-menu aria-labelledby="lrnapp-fab-menu"></lrnapp-fab-menu>`);
