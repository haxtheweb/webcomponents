...
describe('Instantiation Test', () => {
    it('paper-input-flagged instantiates', async () => {
      const el = await fixture(html` <paper-input-flagged title="test-title"></paper-input-flagged> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('paper-input-flagged passes accessibility negation', async () => {
        const el = await fixture(html`<paper-input-flagged aria-labelledby="paper-input-flagged"></paper-input-flagged>`);
