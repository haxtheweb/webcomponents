...
describe('Instantiation Test', () => {
    it('r-coder instantiates', async () => {
      const el = await fixture(html` <r-coder title="test-title"></r-coder> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('r-coder passes accessibility negation', async () => {
        const el = await fixture(html`<r-coder aria-labelledby="r-coder"></r-coder>`);
