...
describe('Instantiation Test', () => {
    it('html-block instantiates', async () => {
      const el = await fixture(html` <html-block title="test-title"></html-block> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('html-block passes accessibility negation', async () => {
        const el = await fixture(html`<html-block aria-labelledby="html-block"></html-block>`);
