...
describe('Instantiation Test', () => {
    it('simple-drawer instantiates', async () => {
      const el = await fixture(html` <simple-drawer title="test-title"></simple-drawer> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-drawer passes accessibility negation', async () => {
        const el = await fixture(html`<simple-drawer aria-labelledby="simple-drawer"></simple-drawer>`);
