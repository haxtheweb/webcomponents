...
describe('Instantiation Test', () => {
    it('lrnsys-progress instantiates', async () => {
      const el = await fixture(html` <lrnsys-progress title="test-title"></lrnsys-progress> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrnsys-progress passes accessibility negation', async () => {
        const el = await fixture(html`<lrnsys-progress aria-labelledby="lrnsys-progress"></lrnsys-progress>`);
