(function() {
  ...
  function GitGraph(options) {
    ...
    this.element = "object" === typeof options.element ? options.element : null;
    this.author =
  ...
  function Branch(options) {
    if (!1 === options.parent instanceof GitGraph) {
      return;
    }
    options = _isObject(options) ? options : {};
  ...
  Branch.prototype.commit = function(options) {
    ...
    if (
      !1 === options.parentCommit instanceof Commit &&
  ...
  Branch.prototype.merge = function(target, commitOptions) {
    ...
    if (!1 === targetBranch instanceof Branch || targetBranch === this) {
      return this;
    }
    ...
    if ("object" !== typeof commitOptions) {
  ...
  function _isNullOrUndefined(obj, key) {
    return !key.split(".").every(function(x) {
      if ("object" !== typeof obj || null === obj || !(x in obj)) {
        return !1;
      }
      obj = obj[x];
      return !0;
