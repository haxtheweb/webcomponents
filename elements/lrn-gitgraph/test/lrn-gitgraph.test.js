...
describe('Instantiation Test', () => {
    it('lrn-gitgraph instantiates', async () => {
      const el = await fixture(html` <lrn-gitgraph title="test-title"></lrn-gitgraph> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrn-gitgraph passes accessibility negation', async () => {
        const el = await fixture(html`<lrn-gitgraph aria-labelledby="lrn-gitgraph"></lrn-gitgraph>`);
