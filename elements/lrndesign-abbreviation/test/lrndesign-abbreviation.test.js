...
import '../src/lrndesign-abbreviation.js';
...
describe('Instantiation Test', () => {
    it('lrndesign-abbreviation instantiates', async () => {
      const el = await fixture(html` <lrndesign-abbreviation title="test-title"></lrndesign-abbreviation> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrndesign-abbreviation passes accessibility negation', async () => {
        const el = await fixture(html`<lrndesign-abbreviation aria-labelledby="lrndesign-abbreviation"></lrndesign-abbreviation>`);
