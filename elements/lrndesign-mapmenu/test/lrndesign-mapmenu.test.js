...
describe('Instantiation Test', () => {
    it('lrndesign-mapmenu instantiates', async () => {
      const el = await fixture(html` <lrndesign-mapmenu title="test-title"></lrndesign-mapmenu> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrndesign-mapmenu passes accessibility negation', async () => {
        const el = await fixture(html`<lrndesign-mapmenu aria-labelledby="lrndesign-mapmenu"></lrndesign-mapmenu>`);
