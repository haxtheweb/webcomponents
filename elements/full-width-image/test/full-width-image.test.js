...
import '../src/full-width-image.js';
...
describe('Instantiation Test', () => {
    it('full-width-image instantiates', async () => {
      const el = await fixture(html` <full-width-image title="test-title"></full-width-image> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('full-width-image passes accessibility negation', async () => {
        const el = await fixture(html`<full-width-image aria-labelledby="full-width-image"></full-width-image>`);
