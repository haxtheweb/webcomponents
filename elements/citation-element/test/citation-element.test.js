...
describe('Instantiation Test', () => {
    it('citation-element instantiates', async () => {
      const el = await fixture(html` <citation-element title="test-title"></citation-element> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('citation-element passes accessibility negation', async () => {
        const el = await fixture(html`<citation-element aria-labelledby="citation-element"></citation-element>`);
