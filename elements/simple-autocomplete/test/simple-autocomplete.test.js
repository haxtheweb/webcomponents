...
import '../src/simple-autocomplete.js';
...
describe('Instantiation Test', () => {
    it('simple-autocomplete instantiates', async () => {
      const el = await fixture(html` <simple-autocomplete title="test-title"></simple-autocomplete> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-autocomplete passes accessibility negation', async () => {
        const el = await fixture(html`<simple-autocomplete aria-labelledby="simple-autocomplete"></simple-autocomplete>`);
