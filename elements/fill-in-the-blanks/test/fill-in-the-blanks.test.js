...
describe("FillInTheBlanks test", () => {
  ...
  it("extends MarkTheWords correctly", async () => {
    ...
    expect(Object.getPrototypeOf(element.constructor).name).to.equal("MarkTheWords");
  });
  ...
  it("parses synonym answers with tilde separator", async () => {
    ...
    expect(element.answers[0].answer).to.deep.equal(["good", "great", "awesome"]);
  ...
  it("handles mixed answer types in same statement", async () => {
    element.statement = "HAX is [good~great] at creating [content|videos|games].";
    await element.updateComplete;
  ...
  it("renders text input fields for single answers", async () => {
    ...
    const textFields = element.shadowRoot.querySelectorAll('simple-fields-field[type="textfield"]');
  ...
  it("renders select fields for multiple choice answers", async () => {
    ...
    const selectFields = element.shadowRoot.querySelectorAll('simple-fields-field[type="select"]');
  ...
  it("shows correct number of options in select dropdown", async () => {
    ...
    const selectField = element.shadowRoot.querySelector('simple-fields-field[type="select"]');
  ...
  it("validates correct synonym answers", async () => {
    ...
    const textField = element.shadowRoot.querySelector('simple-fields-field[type="textfield"]');
  ...
  it("resets user answers correctly", async () => {
    ...
    const resetFields = element.shadowRoot.querySelectorAll('simple-fields-field[type="textfield"]');
  ...
  it("resets select field indices", async () => {
    ...
    const resetSelectField = element.shadowRoot.querySelector('simple-fields-field[type="select"]');
  ...
  it("applies correct styling when showing answers", async () => {
    ...
    const updatedFields = element.shadowRoot.querySelectorAll('simple-fields-field[type="textfield"]');
  ...
  it("works with HAX demoSchema example", async () => {
    ...
    element.statement = "[hax] is really [good~great] at authoring [content|kittens|kites|moons] which is nice..";
    await element.updateComplete;
    ...
    expect(element.answers[2].possible).to.include.members(["content", "kittens", "kites", "moons"]);
    
    // Should render one text field and two other fields (one text for synonyms, one select for multiple choice)
    const allFields = element.shadowRoot.querySelectorAll('simple-fields-field');
