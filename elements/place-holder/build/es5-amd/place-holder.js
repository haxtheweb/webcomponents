define([
  ...
  function _templateObject_ef7dff50f32d11e893668bc44fdc2fc1() {
    ...
    _templateObject_ef7dff50f32d11e893668bc44fdc2fc1 = function _templateObject_ef7dff50f32d11e893668bc44fdc2fc1() {
      return data;
    };
    return data;
  }
  var PlaceHolder = (0, _polymerLegacy.Polymer)({
    _template: (0, _polymerLegacy.html)(
      _templateObject_ef7dff50f32d11e893668bc44fdc2fc1()
    ),
    is: "place-holder",
    ...
    fireReplaceEvent: function fireReplaceEvent(e) {
      this.fire("place-holder-replace", this.type);
    },
    _getCalcText: function _getCalcText(text, type, dragOver) {
      if (dragOver) {
        return "Upload file";
      } else if ("" === text) {
    ...
    _getIconFromType: function _getIconFromType(type, dragOver) {
      if (!dragOver) {
        switch (type) {
          case "document":
    ...
    ready: function ready() {
      if (
        babelHelpers.typeof(this.__dropAdded) ===
