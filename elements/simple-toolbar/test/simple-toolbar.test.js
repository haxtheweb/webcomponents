...
describe('Instantiation Test', () => {
    it('simple-toolbar instantiates', async () => {
      const el = await fixture(html` <simple-toolbar title="test-title"></simple-toolbar> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-toolbar passes accessibility negation', async () => {
        const el = await fixture(html`<simple-toolbar aria-labelledby="simple-toolbar"></simple-toolbar>`);
