    ...
    function (_SuperClass) {
      ...
      _createClass(_class, [{
        ...
        value: function render() {
          return (0, _lit.html)(_templateObject(), this.buttonTemplate);
        }
        /**
        ...
        key: "iconTemplate",
        get: function get() {
          return !this.hasIcon ? "" : (0, _lit.html)(_templateObject2(), this.currentIcon);
        }
        /**
        ...
        key: "labelTemplate",
        get: function get() {
          return !this.hasLabel ? "" : (0, _lit.html)(_templateObject3(), this.labelVisible ? "" : "offscreen", this.currentLabel);
        }
        /**
        ...
        key: "tooltipTemplate",
        get: function get() {
          return !this.tooltipVisible ? "" : (0, _lit.html)(_templateObject4(), this.tooltipDirection || "bottom", this.currentTooltip || this.currentLabel);
        }
        /**
        ...
        get: function get() {
          return this.iconPosition !== "right" || this.iconPosition !== "bottom" ? (0, _lit.html)(_templateObject5(), this.labelTemplate, this.iconTemplate) : (0, _lit.html)(_templateObject6(), this.iconTemplate, this.labelTemplate);
        }
        /**
        ...
        key: "buttonTemplate",
        get: function get() {
          return this.radio ? (0, _lit.html)(_templateObject7(), this.isToggled ? "true" : "false", !!this.describedby && this.describedby !== "" ? this.describedby : undefined, this.disabled, this.controls, this._handleClick, this._handleKeys, this._handleKeydown, this._handleBlur, this._handleFocus, this.isCurrentItem ? 1 : -1, this.buttonInnerTemplate, this.tooltipTemplate) : this.toggles ? (0, _lit.html)(_templateObject8(), this.isToggled ? "true" : "false", !!this.describedby && this.describedby !== "" ? this.describedby : undefined, this.disabled, this.controls, this._handleClick, this._handleKeys, this._handleBlur, this._handleFocus, this.isCurrentItem ? 1 : -1, this.buttonInnerTemplate, this.tooltipTemplate) : (0, _lit.html)(_templateObject9(), !!this.describedby && this.describedby !== "" ? this.describedby : undefined, this.disabled, this.controls, this._handleClick, this._handleKeys, this._handleBlur, this._handleFocus, this.isCurrentItem ? 1 : -1, this.buttonInnerTemplate, this.tooltipTemplate);
        }
      }], [{
        key: "labelStyles",
        get: function get() {
          return [(0, _lit.css)(_templateObject10())];
        }
        /**
        ...
        key: "iconStyles",
        get: function get() {
          return [(0, _lit.css)(_templateObject11())];
        }
        /**
        ...
        key: "tooltipStyles",
        get: function get() {
          return [(0, _lit.css)(_templateObject12())];
        }
        /**
        ...
        get: function get() {
          return [(0, _lit.css)(_templateObject13())];
        }
        /**
        ...
        get: function get() {
          return [(0, _lit.css)(_templateObject14())];
        }
        /**
        ...
        get: function get() {
          return [(0, _lit.css)(_templateObject15())];
        }
        /**
...
}(SimpleToolbarButtonBehaviors(_lit.LitElement));
