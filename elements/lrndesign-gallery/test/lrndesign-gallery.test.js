...
import '../src/lrndesign-gallery.js';
...
describe('Instantiation Test', () => {
    it('lrndesign-gallery instantiates', async () => {
      const el = await fixture(html` <lrndesign-gallery title="test-title"></lrndesign-gallery> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrndesign-gallery passes accessibility negation', async () => {
        const el = await fixture(html`<lrndesign-gallery aria-labelledby="lrndesign-gallery"></lrndesign-gallery>`);
