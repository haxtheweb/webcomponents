...
import "../lrndesign-drawer.js";

describe("lrndesign-drawer test", () => {
  let element;
  beforeEach(async () => {
    element = await fixture(
      html` <lrndesign-drawer title="test-title"></lrndesign-drawer> `
    );
  });
...
describe("A11y/chai axe tests", () => {
  ...
  it("lrndesign-drawer passes accessibility negation", async () => {
    const el = await fixture(
      html`<lrndesign-drawer
        aria-labelledby="lrndesign-drawer"
      ></lrndesign-drawer>`
    );
