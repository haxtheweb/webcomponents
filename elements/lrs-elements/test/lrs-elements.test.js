...
describe('Instantiation Test', () => {
    it('lrs-elements instantiates', async () => {
      const el = await fixture(html` <lrs-elements title="test-title"></lrs-elements> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrs-elements passes accessibility negation', async () => {
        const el = await fixture(html`<lrs-elements aria-labelledby="lrs-elements"></lrs-elements>`);
