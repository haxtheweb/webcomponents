...
import '../src/json-outline-schema.js';
...
describe('Instantiation Test', () => {
    it('json-outline-schema instantiates', async () => {
      const el = await fixture(html` <json-outline-schema title="test-title"></json-outline-schema> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('json-outline-schema passes accessibility negation', async () => {
        const el = await fixture(html`<json-outline-schema aria-labelledby="json-outline-schema"></json-outline-schema>`);
