...
describe('Instantiation Test', () => {
    it('layout-builder instantiates', async () => {
      const el = await fixture(html` <layout-builder title="test-title"></layout-builder> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('layout-builder passes accessibility negation', async () => {
        const el = await fixture(html`<layout-builder aria-labelledby="layout-builder"></layout-builder>`);
