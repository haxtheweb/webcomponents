...
describe('Instantiation Test', () => {
    it('chartist-render instantiates', async () => {
      const el = await fixture(html` <chartist-render title="test-title"></chartist-render> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('chartist-render passes accessibility negation', async () => {
        const el = await fixture(html`<chartist-render aria-labelledby="chartist-render"></chartist-render>`);
