 ...
 */var ChartistRender=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(ChartistRender,_PolymerElement);function ChartistRender(){babelHelpers.classCallCheck(this,ChartistRender);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(ChartistRender).apply(this,arguments))}babelHelpers.createClass(ChartistRender,[{key:"connectedCallback",/**
   ...
   */value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(ChartistRender.prototype),"connectedCallback",this).call(this);var root=this,name="chartistLib",basePath=(0,_resolveUrl.pathFromUrl)(decodeURIComponent(meta.url)),location="".concat(basePath,"lib/chartist/dist/chartist.min.js");window.addEventListener("es-bridge-".concat(name,"-loaded"),root._chartistLoaded.bind(root));window.ESGlobalBridge.requestAvailability();window.ESGlobalBridge.instance.load(name,location)}/**
...
get:function get(){return(0,_polymerElement.html)(_templateObject_96531c806a8311e98eece5ec61c8a314())}// properties available to the custom element for data binding
