...
describe('Instantiation Test', () => {
    it('i18n-manager instantiates', async () => {
      const el = await fixture(html` <i18n-manager title="test-title"></i18n-manager> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('i18n-manager passes accessibility negation', async () => {
        const el = await fixture(html`<i18n-manager aria-labelledby="i18n-manager"></i18n-manager>`);
