...
import '../src/fullscreen-behaviors.js';
...
describe('Instantiation Test', () => {
    it('fullscreen-behaviors instantiates', async () => {
      const el = await fixture(html` <fullscreen-behaviors title="test-title"></fullscreen-behaviors> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('fullscreen-behaviors passes accessibility negation', async () => {
        const el = await fixture(html`<fullscreen-behaviors aria-labelledby="fullscreen-behaviors"></fullscreen-behaviors>`);
