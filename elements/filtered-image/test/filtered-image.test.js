...
describe('Instantiation Test', () => {
    it('filtered-image instantiates', async () => {
      const el = await fixture(html` <filtered-image title="test-title"></filtered-image> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('filtered-image passes accessibility negation', async () => {
        const el = await fixture(html`<filtered-image aria-labelledby="filtered-image"></filtered-image>`);
