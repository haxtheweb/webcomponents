...
describe('Instantiation Test', () => {
    it('a11y-details instantiates', async () => {
      const el = await fixture(html` <a11y-details title="test-title"></a11y-details> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('a11y-details passes accessibility negation', async () => {
        const el = await fixture(html`<a11y-details aria-labelledby="a11y-details"></a11y-details>`);
