...
exports.EndUserDocBehaviors = exports.EndUserDoc = void 0;
...
var EndUserDocBehaviors = function EndUserDocBehaviors(SuperClass) {
  return (
    /*#__PURE__*/
...
exports.EndUserDocBehaviors = EndUserDocBehaviors;

var EndUserDoc =
/*#__PURE__*/
function (_EndUserDocBehaviors) {
  _inherits(EndUserDoc, _EndUserDocBehaviors);

  function EndUserDoc() {
    _classCallCheck(this, EndUserDoc);

    return _possibleConstructorReturn(this, _getPrototypeOf(EndUserDoc).apply(this, arguments));
  }

  return EndUserDoc;
}(EndUserDocBehaviors(_litElement.LitElement));
