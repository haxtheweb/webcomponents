...
describe('Instantiation Test', () => {
    it('self-check instantiates', async () => {
      const el = await fixture(html` <self-check title="test-title"></self-check> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('self-check passes accessibility negation', async () => {
        const el = await fixture(html`<self-check aria-labelledby="self-check"></self-check>`);
