define(["exports","./node_modules/lit-element/lit-element.js","./node_modules/@lrnwebcomponents/hax-body-behaviors/lib/HAXWiring.js"],function(_exports,_litElement,_HAXWiring){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.MicroCopyHeading=void 0;function _templateObject_7010b6f0ab1411e98a6b6f8f3d975bcd(){var data=babelHelpers.taggedTemplateLiteral(["\n<style>:host {\n  display: block;\n  margin: 16px 0;\n}\n\n:host([hidden]) {\n  display: none;\n}\nspan {\n  margin-left:8px;\n}\nh2 {\n  display: inline-flex;\n  margin: unset;\n  padding: unset;\n  font-size: 0.750em;\n  color: var(--simple-colors-default-theme-red-5, #DE2654);\n  border: 2px solid var(--simple-colors-default-theme-red-5, #DE2654);\n  line-height: 12px;\n  margin-right: 10px;\n  text-transform: uppercase;\n  font-weight: 500;\n  letter-spacing: 0.09em;\n  padding: 6px 16px;\n}</style>\n<h2>","<span aria-hidden=\"true\">","</span></h2>"]);_templateObject_7010b6f0ab1411e98a6b6f8f3d975bcd=function _templateObject_7010b6f0ab1411e98a6b6f8f3d975bcd(){return data};return data}/**
 * `micro-copy-heading`
...
value:function render(){return(0,_litElement.html)(_templateObject_7010b6f0ab1411e98a6b6f8f3d975bcd(),this.heading,this.endcap)}// haxProperty definition
},{key:"tag",/**
   ...
   */endcap:{name:"endcap",type:String,value:"//"}};if(babelHelpers.get(babelHelpers.getPrototypeOf(MicroCopyHeading),"properties",this)){props=Object.assign(props,babelHelpers.get(babelHelpers.getPrototypeOf(MicroCopyHeading),"properties",this))}return props}}]);function MicroCopyHeading(){var _this;babelHelpers.classCallCheck(this,MicroCopyHeading);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(MicroCopyHeading).call(this));_this.tag=MicroCopyHeading.tag;// map our imported properties json to real props on the element
