...
describe('Instantiation Test', () => {
    it('simple-blog instantiates', async () => {
      const el = await fixture(html` <simple-blog title="test-title"></simple-blog> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-blog passes accessibility negation', async () => {
        const el = await fixture(html`<simple-blog aria-labelledby="simple-blog"></simple-blog>`);
