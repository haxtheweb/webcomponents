...
describe('Instantiation Test', () => {
    it('portal-launcher instantiates', async () => {
      const el = await fixture(html` <portal-launcher title="test-title"></portal-launcher> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('portal-launcher passes accessibility negation', async () => {
        const el = await fixture(html`<portal-launcher aria-labelledby="portal-launcher"></portal-launcher>`);
