...
describe('Instantiation Test', () => {
    it('magazine-cover instantiates', async () => {
      const el = await fixture(html` <magazine-cover title="test-title"></magazine-cover> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('magazine-cover passes accessibility negation', async () => {
        const el = await fixture(html`<magazine-cover aria-labelledby="magazine-cover"></magazine-cover>`);
