...
Polymer({
  ...
  beforeRegister: function() {
    var ironInput = document.createElement("iron-input"),
      version = "function" == typeof ironInput._initSlottedInput ? "v1" : "v0",
      template = DomModule.import("paper-input", "template"),
      inputTemplate = DomModule.import("paper-input", "template#" + version),
