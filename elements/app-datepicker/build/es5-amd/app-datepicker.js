define([
  ...
  _neonAnimatedPages,
  _appDatepickerIcons,
  _appDatepickerAnimations
) {
  "use strict";
  async = babelHelpers.interopRequireWildcard(async);
  function _templateObject_60709ab0f1e411e8b22911fdcb235d6b() {
    ...
    _templateObject_60709ab0f1e411e8b22911fdcb235d6b = function _templateObject_60709ab0f1e411e8b22911fdcb235d6b() {
      return data;
    };
    return data;
  }
  (0, _polymerLegacy.Polymer)({
    _template: (0, _polymerLegacy.html)(
      _templateObject_60709ab0f1e411e8b22911fdcb235d6b()
    ),
    is: "app-datepicker",
    ...
    _isChosenDaysOfMonth: function _isChosenDaysOfMonth(
      _item,
      _selectedYear,
      _selectedMonth,
      _selectedDate
    ...
    _isDisableDays: function _isDisableDays(
      _index,
      _firstDayOfWeek,
      _minDate,
      _maxDate,
    ...
    _onListRendered: function _onListRendered(ev) {
      ...
      if (ev.target.if && this.noAnimation) {
        async.microTask.run(function() {
          _this3._updateListScroller(
            _this3.shadowRoot.querySelector("#listOfYears")
          );
        });
      }
    },
    ...
    _updateThemeColor: function _updateThemeColor(_theme) {
      var _themes = ["dark-theme", "light-theme", "goog-theme"],
        ...
        _distributedButtons = (0, _polymerDom.dom)(this).querySelectorAll(
          "paper-button"
        ),
