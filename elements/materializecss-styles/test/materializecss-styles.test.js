...
import '../src/materializecss-styles.js';
...
describe('Instantiation Test', () => {
    it('materializecss-styles instantiates', async () => {
      const el = await fixture(html` <materializecss-styles title="test-title"></materializecss-styles> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('materializecss-styles passes accessibility negation', async () => {
        const el = await fixture(html`<materializecss-styles aria-labelledby="materializecss-styles"></materializecss-styles>`);
