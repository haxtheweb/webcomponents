    ...
    toSVG: function(HW, DD) {
      ...
      for (var n in notation) {
        ...
        switch (n) {
          ...
          case MML.NOTATION.ROUNDEDBOX:
            svg.Add(
              BBOX.FRAME(H, D, W, t, "solid", values.mathcolor, {
          ...
          case MML.NOTATION.VERTICALSTRIKE:
            svg.Add(
              BBOX.VLINE(H + D, t, "solid", values.mathcolor),
              (W - t) / 2,
              -D
            );
            break;
          ...
          case MML.NOTATION.HORIZONTALSTRIKE:
            svg.Add(
              BBOX.HLINE(W, t, "solid", values.mathcolor),
              0,
              (H + D - t) / 2 - D
            );
            break;
          ...
          case MML.NOTATION.UPDIAGONALARROW:
            ...
            var x = 0.4 * h;
            svg.Add(
              BBOX.DLINE(H - 0.5 * h, D, W - 0.5 * w, t, values.mathcolor, "up")
            );
            svg.Add(
              BBOX.FPOLY(
                [
      ...
      for (i = 0; i < 4; i++) {
        if (borders[i]) {
          var side = sides[i];
          svg.Add(
            BBOX[side[0] + "LINE"](side[1], t, "solid", values.mathcolor),
            side[2],
            side[3]
          );
        }
