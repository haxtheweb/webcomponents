  ...
  HUB.Register.LoadHook(HTMLCSS.fontDir + "/fontdata.js", function() {
    HTMLCSS.Augment({
      ...
      handleImg: function(span, font, c, n, text) {
        ...
        c[4] = orig[4] * factor;
        var dir =
          this.imgDir + "/" + font.directory + "/" + this.imgSize[index];
      ...
      initImg: function(span) {
        ...
        if (
          i &&
          this.imgEmWidth[i] - this.em > this.em - this.imgEmWidth[i - 1]
        ) {
          i--;
        }
