...
(function(CHTML, MML, AJAX) {
  ...
  MathJax.Hub.Register.LoadHook(
    CHTML.fontDir + "/TeX/Main-Bold.js",
    function() {
  ...
  MathJax.Hub.Register.LoadHook(
    CHTML.fontDir + "/TeX/Typewriter-Regular.js",
    function() {
  ...
  CHTML.FONTDATA.familyName = function(font) {
    ...
    var suffix =
      names[0].toLowerCase().replace(/(?:igraphic|serif|writer|tur|tor)$/, "") +
      "-" +
