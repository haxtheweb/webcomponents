    ...
    CHTMLaddLabels: function(values, state, node, table) {
      ...
      if (shift) {
        if (indent.indentalign === MML.INDENTALIGN.CENTER) {
          ...
          var margin =
            "margin" +
            (indent.indentalign === MML.INDENTALIGN.RIGHT ? "Right" : "Left");
