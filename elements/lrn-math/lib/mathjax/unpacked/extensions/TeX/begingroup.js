...
MathJax.Hub.Register.StartupHook("TeX Jax Ready", function() {
  ...
  var NSSTACK = (TEX.nsStack = MathJax.Object.Subclass(
    {
      ...
      Merge: function(stack) {
        ...
        var data = [this.top, this.stack.length - this.top].concat(
          stack.stack.slice(1)
        );
  ...
  TEX.Parse.Augment({
    ...
    csFindMacro: function(name) {
      return (
        TEX.eqnStack.Find(name, "macros") || TEX.rootStack.Find(name, "macros")
      );
    },
    envFindName: function(name) {
      return (
        TEX.eqnStack.Find(name, "environments") ||
        TEX.rootStack.Find(name, "environments")
      );
    },
