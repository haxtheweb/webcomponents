...
MathJax.Hub.Register.StartupHook("TeX Jax Ready", function() {
  ...
  TEX.Parse.Augment({
    ...
    HandleOperatorName: function(name) {
      ...
      op = op.replace(/\*/g, "\\text{*}").replace(/-/g, "\\text{-}");
      this.string =
        "\\mathop{\\rm " + op + "}" + limits + " " + this.string.slice(this.i);
      this.i = 0;
    },
