...
(function(HUB, HTML, AJAX, HTMLCSS, nMML) {
  ...
  var ZOOM = (MathJax.Extension.MathZoom = {
    ...
    SetWH: function() {
      ...
      var doc =
        overlay.scroll_parent || document.documentElement || document.body;
