...
ace.define("ace/lib/useragent", ["require", "exports", "module"], function(
  ...
  if ("object" != typeof navigator) return;
  ...
  function(require, exports) {
    ...
    exports.buildDom = function buildDom(arr, parent, refs) {
      ...
      var el = document.createElement(arr[0]),
        options = arr[1],
        childIndex = 1;
      if (options && "object" == typeof options && !Array.isArray(options))
        childIndex = 2;
...
ace.define("ace/lib/lang", ["require", "exports", "module"], function(
  ...
  exports.copyArray = function(array) {
    for (var copy = [], i = 0, l = array.length; i < l; i++) {
      if (array[i] && "object" == typeof array[i])
  ...
  function(require, exports) {
    ...
    var event = require("../lib/event"),
      ...
      TextInput = function(parentNode, host) {
        ...
        var afterContextMenu = !1,
          sendText = function(value, fromInput) {
            if (afterContextMenu) afterContextMenu = !1;
            if (pasted) {
              resetSelection();
...
ace.define(
  ...
  function(require, exports) {
    ...
    function reportError(msg, data) {
      var e = new Error(msg);
      e.data = data;
      if ("object" == typeof console && console.error) console.error(e);
      setTimeout(function() {
        throw e;
      });
    }
...
ace.define(
  ...
  function(require, exports) {
    ...
    var lang = require("./lib/lang"),
      oop = require("./lib/oop"),
      Range = require("./range").Range,
      SearchHighlight = function(regExp, clazz, type) {
  ...
  function(require, exports) {
    ...
    var _NumberMAX_VALUE = Number.MAX_VALUE,
      ...
      EditSession = function(text, mode) {
        ...
        this.$onChange = this.onChange.bind(this);
        if ("object" != typeof text || !text.getLine) text = new Document(text);
      ...
      this.addCommands = function(commands) {
        commands &&
          Object.keys(commands).forEach(function(name) {
            ...
            if ("object" !== typeof command) return;
...
ace.define(
  ...
  function(require, exports) {
    ...
    var oop = require("./lib/oop"),
      ...
      Editor = function(renderer, session, options) {
    ...
    (function() {
      ...
      this.find = function(needle, options, animate) {
        if (!options) options = {};
        if ("string" == typeof needle || needle instanceof RegExp)
          options.needle = needle;
        else if ("object" == typeof needle) oop.mixin(options, needle);
        var range = this.selection.getRange();
...
ace.define(
  ...
  function(require, exports) {
    ...
    var _Mathfloor3 = Math.floor,
      dom = require("../lib/dom"),
      Lines = function(element, canvasHeight) {
  ...
  function(require, exports) {
    ...
    (function() {
      ...
      this.updateMarkers = function() {
        ...
        var _self = this,
          session = this.session,
          updateMarker = function(pos, className) {
    ...
    (function() {
      ...
      this.rectangularRangeBlock = function(
        ...
        if (!includeEmptyLines) {
          ...
          while (rectSel[end].isEmpty() && 0 < end) end--;
          if (0 < end) {
            var start = 0;
    ...
    (function() {
      ...
      this.forEachSelection = function(cmd, args, options) {
        ...
        for (var i = ranges.length; i--; ) {
          if ($byLines) {
            while (0 < i && ranges[i].start.row == ranges[i - 1].end.row) i--;
          }
  ...
  function(require, exports) {
    ...
    (function() {
      ...
      this.renderWidgets = function(e, renderer) {
        ...
        while (0 < first && !lineWidgets[first]) first--;
