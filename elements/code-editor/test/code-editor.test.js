...
describe('Instantiation Test', () => {
    it('code-editor instantiates', async () => {
      const el = await fixture(html` <code-editor title="test-title"></code-editor> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('code-editor passes accessibility negation', async () => {
        const el = await fixture(html`<code-editor aria-labelledby="code-editor"></code-editor>`);
