...
ace.define(
  ...
  function(require, exports, module) {
    ...
    var TextHighlightRules = require("./text_highlight_rules")
      .TextHighlightRules;
    var PerlHighlightRules = require("./perl_highlight_rules")
      .PerlHighlightRules;
    var PythonHighlightRules = require("./python_highlight_rules")
      .PythonHighlightRules;
    var JsonHighlightRules = require("./json_highlight_rules")
      .JsonHighlightRules;
...
ace.define(
  ...
  function(require, exports, module) {
    ...
    var PgsqlHighlightRules = require("./pgsql_highlight_rules")
      .PgsqlHighlightRules;
