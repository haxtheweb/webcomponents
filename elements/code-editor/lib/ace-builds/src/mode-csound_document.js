          ...
          if (Array.isArray(params.next)) {
            ...
            if (newNextIndex > oldNextIndex) {
              while (oldNextIndex >= 0 && newNextIndex >= 0) {
                if (
                  oldNext.charAt(oldNextIndex) !== next.charAt(newNextIndex)
                ) {
...
define("ace/mode/csound_document_highlight_rules", [
  ...
  var CsoundOrchestraHighlightRules = require("./csound_orchestra_highlight_rules")
...
define("ace/mode/csound_document", [
  ...
  var CsoundDocumentHighlightRules = require("./csound_document_highlight_rules")
