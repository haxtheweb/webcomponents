...
describe('Instantiation Test', () => {
    it('date-card instantiates', async () => {
      const el = await fixture(html` <date-card title="test-title"></date-card> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('date-card passes accessibility negation', async () => {
        const el = await fixture(html`<date-card aria-labelledby="date-card"></date-card>`);
