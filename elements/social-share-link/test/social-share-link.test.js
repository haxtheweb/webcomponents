...
describe('Instantiation Test', () => {
    it('social-share-link instantiates', async () => {
      const el = await fixture(html` <social-share-link title="test-title"></social-share-link> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('social-share-link passes accessibility negation', async () => {
        const el = await fixture(html`<social-share-link aria-labelledby="social-share-link"></social-share-link>`);
