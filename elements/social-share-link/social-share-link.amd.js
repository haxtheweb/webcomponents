...
get:function get(){return(0,_polymerElement.html)(_templateObject_ac8e9880ab1511e9a15b350fad7e62f7())}// properties available to the custom element for data binding
   ...
   */__linkText:{name:"__linkText",type:String,computed:"_getLinkText(text,type)"}};if(babelHelpers.get(babelHelpers.getPrototypeOf(SocialShareLink),"properties",this)){props=Object.assign(props,babelHelpers.get(babelHelpers.getPrototypeOf(SocialShareLink),"properties",this))}return props}/**
