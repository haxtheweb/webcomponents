...
describe('Instantiation Test', () => {
    it('simple-login instantiates', async () => {
      const el = await fixture(html` <simple-login title="test-title"></simple-login> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-login passes accessibility negation', async () => {
        const el = await fixture(html`<simple-login aria-labelledby="simple-login"></simple-login>`);
