...
describe('Instantiation Test', () => {
    it('haxor-slevin instantiates', async () => {
      const el = await fixture(html` <haxor-slevin title="test-title"></haxor-slevin> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('haxor-slevin passes accessibility negation', async () => {
        const el = await fixture(html`<haxor-slevin aria-labelledby="haxor-slevin"></haxor-slevin>`);
