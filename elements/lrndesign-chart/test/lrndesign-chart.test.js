...
describe('Instantiation Test', () => {
    it('lrndesign-chart instantiates', async () => {
      const el = await fixture(html` <lrndesign-chart title="test-title"></lrndesign-chart> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrndesign-chart passes accessibility negation', async () => {
        const el = await fixture(html`<lrndesign-chart aria-labelledby="lrndesign-chart"></lrndesign-chart>`);
