...
describe("product-glance test", () => {
  ...
  describe('Component Structure', () => {
    ...
    it('should have HAX properties', () => {
      ...
      expect(ProductGlance.haxProperties).to.include('product-glance.haxProperties.json');
    });
  });
  ...
  describe('Slot Content', () => {
    ...
    it('should support subtitle slot', async () => {
      ...
      await slottedElement.updateComplete;
      const subtitleSlot = slottedElement.shadowRoot.querySelector('slot[name="subtitle"]');
  ...
  describe('Multiple Instances', () => {
    it('should support multiple independent instances', async () => {
      ...
      expect(icon1?.getAttribute('icon')).to.equal('star');
      expect(icon2?.getAttribute('icon')).to.equal('heart');
    });
  });
