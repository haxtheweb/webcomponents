...
`,
  ...
  properties: {
    ...
    activatedAction: { type: Action, value: void 0, readOnly: !0, notify: !0 },
    activatedActionId: {
      type: String,
      value: void 0,
      notify: !0,
  ...
  listeners: { "iron-resize": "_onResize", "dom-mutation": "_refreshActions" },
  ready: function() {
  ...
  _onActivatedActionIdChange: function(newValue) {
