...
describe('Instantiation Test', () => {
    it('hax-logo instantiates', async () => {
      const el = await fixture(html` <hax-logo title="test-title"></hax-logo> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('hax-logo passes accessibility negation', async () => {
        const el = await fixture(html`<hax-logo aria-labelledby="hax-logo"></hax-logo>`);
