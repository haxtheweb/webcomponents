...
describe('Instantiation Test', () => {
    it('lrnsys-outline instantiates', async () => {
      const el = await fixture(html` <lrnsys-outline title="test-title"></lrnsys-outline> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrnsys-outline passes accessibility negation', async () => {
        const el = await fixture(html`<lrnsys-outline aria-labelledby="lrnsys-outline"></lrnsys-outline>`);
