define([
  ...
  "./hax-stax-picker.js",
  "./hax-blox-picker.js"
], function(meta, _polymerLegacy) {
  "use strict";
  meta = babelHelpers.interopRequireWildcard(meta);
  function _templateObject_71d1bca0edbe11e883a5d91bd26efb3f() {
    ...
    _templateObject_71d1bca0edbe11e883a5d91bd26efb3f = function() {
      return data;
    };
    return data;
  }
  (0, _polymerLegacy.Polymer)({
    _template: (0, _polymerLegacy.html)(
      _templateObject_71d1bca0edbe11e883a5d91bd26efb3f()
    ),
    is: "hax-panel",
    ...
    _globalPreferencesChanged: function _globalPreferencesChanged(value) {
      if (babelHelpers.typeof(value) !== "undefined") {
        if (
          null != value.value &&
          babelHelpers.typeof(value.value.haxShowExportButton) !== "undefined"
        ) {
          this.hideExportButton = !value.value.haxShowExportButton;
        }
        if (
          null != value.value &&
          babelHelpers.typeof(value.value.haxDeveloperMode) !== "undefined"
        ) {
    ...
    _editModeChanged: function _editModeChanged(newValue) {
    ...
    _clickEditButton: function _clickEditButton() {
      this.toggle();
    },
    ...
    _htmlExportDialog: function _htmlExportDialog() {
      window.HaxStore.instance.haxExport.toggleDialog();
    },
    _preferencesDialog: function _preferencesDialog() {
