...
Polymer({
  ...
  replaceElementWorkflow: function() {
    ...
    if (
      ...
      typeof element.properties.type !== typeof void 0
    ) {
    ...
    if (
      ...
      typeof window.HaxStore.instance.elementList[element.tag].gizmo.handles !==
        typeof void 0 &&
      0 < window.HaxStore.instance.elementList[element.tag].gizmo.handles.length
    ) {
      ...
      for (var i = 0; i < gizmo.handles.length; i++) {
        for (var prop in gizmo.handles[i]) {
          if (
            "type" !== prop &&
            typeof element.properties[gizmo.handles[i][prop]] !== typeof void 0
          ) {
  ...
  haxClearBody: function(confirm = !0) {
    let status = !0;
    if (confirm) {
  ...
  haxToContent: function() {
    ...
    for (var content = "", i = 0, len = children.length; i < len; i++) {
      if (this._haxElementTest(children[i])) {
        ...
        typeof children[i].textContent !== typeof void 0 &&
  ...
  haxDuplicateNode: function(node, parent = this) {
    this.hideContextMenus();
    var nodeClone = dom(node).cloneNode(!0);
    if (
      "webview" === nodeClone.tagName.toLowerCase() &&
      window.HaxStore.instance._isSandboxed &&
      typeof nodeClone.guestinstance !== typeof void 0
    ) {
  ...
  positionContextMenus: function(node, container) {
    ...
    if (typeof props !== typeof void 0 && "P" !== node.tagName) {
  ...
  importContent: function(html, clear = !0) {
    if (clear) {
      window.HaxStore.wipeSlot(this, "*");
    }
    setTimeout(() => {
      ...
      while (null !== fragment.firstChild) {
        if (
          typeof fragment.firstChild.tagName !== typeof void 0 &&
  ...
  _haxContextOperation: function(e) {
    ...
    switch (detail.eventName) {
      ...
      case "hax-edit-property":
        ...
        haxInputMixer.value = "";
        if (
          typeof detail.target.propertyToBind !== typeof void 0 &&
  ...
  _editModeChanged: function(newValue, oldValue) {
    if (typeof oldValue !== typeof void 0) {
      ...
      if (
        !1 !== newValue &&
        typeof this.activeNode !== typeof void 0 &&
  ...
  _activeNodeChanged: function(newValue, oldValue) {
    if (typeof oldValue !== typeof void 0 && null != oldValue) {
    ...
    if (this.editMode) {
      ...
      try {
        ...
        if (
          ...
          while (!focus) {
            if (null == dom(node).nextSibling) {
              focus = !0;
            } else if ("function" === dom(node).nextSibling.focus) {
