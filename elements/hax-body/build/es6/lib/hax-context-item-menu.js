...
`,
  ...
  _selectedUpdated: function(newValue, oldValue) {
    if (
      typeof null !== typeof newValue &&
      typeof oldValue !== typeof void 0 &&
      typeof null !== typeof oldValue
    ) {
      let children = dom(this).getDistributedNodes();
      for (var item = {}, j = 0, i = 0, len = children.length; i < len; i++) {
      ...
      if (
        !this._blockEvent &&
        typeof item.attributes !== typeof void 0 &&
        typeof item.attributes.value !== typeof void 0 &&
        typeof item.attributes.value.value !== typeof void 0
      ) {
        this.$.menu.hideMenu();
