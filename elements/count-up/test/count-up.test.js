...
describe('Instantiation Test', () => {
    it('count-up instantiates', async () => {
      const el = await fixture(html` <count-up title="test-title"></count-up> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('count-up passes accessibility negation', async () => {
        const el = await fixture(html`<count-up aria-labelledby="count-up"></count-up>`);
