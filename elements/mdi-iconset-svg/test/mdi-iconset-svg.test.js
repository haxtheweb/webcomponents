...
describe('Instantiation Test', () => {
    it('mdi-iconset-svg instantiates', async () => {
      const el = await fixture(html` <mdi-iconset-svg title="test-title"></mdi-iconset-svg> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('mdi-iconset-svg passes accessibility negation', async () => {
        const el = await fixture(html`<mdi-iconset-svg aria-labelledby="mdi-iconset-svg"></mdi-iconset-svg>`);
