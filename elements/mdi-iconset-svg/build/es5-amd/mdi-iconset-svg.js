define([
  ...
  _ironIconsetSvg,
  _mdiAccountIconsetSvg,
  _mdiActionIconsetSvg,
  _mdiAgricultureIconsetSvg,
  _mdiAlertIconsetSvg,
  _mdiArrangeIconsetSvg,
  _mdiArrowIconsetSvg,
  _mdiAudioIconsetSvg,
  _mdiAuthIconsetSvg,
  _mdiAvIconsetSvg,
  _mdiBatteryIconsetSvg,
  _mdiBellIconsetSvg,
  _mdiBorderIconsetSvg,
  _mdiBoxIconsetSvg,
  _mdiCameraIconsetSvg,
  _mdiCartIconsetSvg,
  _mdiCircleIconsetSvg,
  _mdiClothingIconsetSvg,
  _mdiCloudIconsetSvg,
  _mdiColorIconsetSvg,
  _mdiCommentIsonsetSvg,
  _mdiCurrencyIconsetSvg,
  _mdiDebugIconsetSvg,
  _mdiDrawingIconsetSvg,
  _mdiEditIconsetSvg,
  _mdiErrorIconsetSvg,
  _mdiFileIconsetSvg,
  _mdiFilterIconsetSvg,
  _mdiFolderIconsetSvg,
  _mdiFormIconsetSvg,
  _mdiFormatIconsetSvg,
  _mdiHardwareIconsetSvg,
  _mdiHelperIconsetSvg,
  _mdiHolidayIconsetSvg,
  _mdiImageIconsetSvg,
  _mdiLocalIconsetSvg,
  _mdiLockIconsetSvg,
  _mdiLogoIconsetSvg,
  _mdiMapIconsetSvg,
  _mdiMarkdownIconsetSvg,
  _mdiMedicalIconsetSvg,
  _mdiMicrophoneIconsetSvg,
  _mdiMinusIconsetSvg,
  _mdiMovieIconsetSvg,
  _mdiOctagonIconsetSvg,
  _mdiOffIconsetSvg,
  _mdiOsIconsetSvg,
  _mdiOutlineIconsetSvg,
  _mdiPhoneIconsetSvg,
  _mdiPinIconsetSvg,
  _mdiPlusIconsetSvg,
  _mdiSettingsIconsetSvg,
  _mdiShapeIconsetSvg,
  _mdiSocialIconsetSvg,
  _mdiSquareIconsetSvg,
  _mdiStoreIconsetSvg,
  _mdiTextIconsetSvg,
  _mdiTimeIconsetSvg,
  _mdiTooltipIconsetSvg,
  _mdiTransformIconsetSvg,
  _mdiTransportationIconsetSvg,
  _mdiUserIconsetSvg,
  _mdiVectorIconsetSvg,
  _mdiVideoIconsetSvg,
  _mdiViewIconsetSvg,
  _mdiVoteIconsetSvg,
  _mdiWeatherIconsetSvg
) {
  "use strict";
});
