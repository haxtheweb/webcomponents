...
describe('Instantiation Test', () => {
    it('media-behaviors instantiates', async () => {
      const el = await fixture(html` <media-behaviors title="test-title"></media-behaviors> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('media-behaviors passes accessibility negation', async () => {
        const el = await fixture(html`<media-behaviors aria-labelledby="media-behaviors"></media-behaviors>`);
