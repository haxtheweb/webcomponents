...
describe('Instantiation Test', () => {
    it('git-corner instantiates', async () => {
      const el = await fixture(html` <git-corner title="test-title"></git-corner> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('git-corner passes accessibility negation', async () => {
        const el = await fixture(html`<git-corner aria-labelledby="git-corner"></git-corner>`);
