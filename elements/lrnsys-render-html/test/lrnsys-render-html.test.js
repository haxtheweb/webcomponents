...
import '../src/lrnsys-render-html.js';
...
describe('Instantiation Test', () => {
    it('lrnsys-render-html instantiates', async () => {
      const el = await fixture(html` <lrnsys-render-html title="test-title"></lrnsys-render-html> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrnsys-render-html passes accessibility negation', async () => {
        const el = await fixture(html`<lrnsys-render-html aria-labelledby="lrnsys-render-html"></lrnsys-render-html>`);
