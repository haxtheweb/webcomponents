...
`,
  ...
  properties: {
    ...
    queryParams: { type: Object, notify: !0, observer: "_queryParamsChanged" },
  ...
  _coursesCompute: function(originalCourses, queryParams) {
    ...
    filteredCourses = originalCourses.filter(course => {
      if ("undefined" !== typeof this.queryParams.course) {
        if (course.id != this.queryParams.course) {
          return !1;
        }
      }
      if ("undefined" !== typeof this.queryParams.program) {
        if (course.relationships.program.id != this.queryParams.program) {
          return !1;
        }
      }
      if ("undefined" !== typeof this.queryParams.academic) {
