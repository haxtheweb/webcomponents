...
import '../src/lrndesign-course-banner.js';
...
describe('Instantiation Test', () => {
    it('lrndesign-course-banner instantiates', async () => {
      const el = await fixture(html` <lrndesign-course-banner title="test-title"></lrndesign-course-banner> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrndesign-course-banner passes accessibility negation', async () => {
        const el = await fixture(html`<lrndesign-course-banner aria-labelledby="lrndesign-course-banner"></lrndesign-course-banner>`);
