...
describe('Instantiation Test', () => {
    it('pdf-browser-viewer instantiates', async () => {
      const el = await fixture(html` <pdf-browser-viewer title="test-title"></pdf-browser-viewer> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('pdf-browser-viewer passes accessibility negation', async () => {
        const el = await fixture(html`<pdf-browser-viewer aria-labelledby="pdf-browser-viewer"></pdf-browser-viewer>`);
