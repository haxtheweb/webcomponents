...
describe('Instantiation Test', () => {
    it('lrnsys-comment instantiates', async () => {
      const el = await fixture(html` <lrnsys-comment title="test-title"></lrnsys-comment> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrnsys-comment passes accessibility negation', async () => {
        const el = await fixture(html`<lrnsys-comment aria-labelledby="lrnsys-comment"></lrnsys-comment>`);
