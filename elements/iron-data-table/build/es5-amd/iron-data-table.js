define([
  ...
  _exports.IronDataTable = void 0;
  var _Mathfloor = Math.floor,
    _Mathmin = Math.min;
  function _templateObject_075bfde0f32c11e8aee46da5b4b83db9() {
    ...
    _templateObject_075bfde0f32c11e8aee46da5b4b83db9 = function _templateObject_075bfde0f32c11e8aee46da5b4b83db9() {
      return data;
    };
    return data;
  }
  var IronDataTable = (0, _polymerLegacy.Polymer)({
    _template: (0, _polymerLegacy.html)(
      _templateObject_075bfde0f32c11e8aee46da5b4b83db9()
    ),
    is: "iron-data-table",
    ...
    created: function created() {
      ...
      this._observer = new _flattenedNodesObserver.FlattenedNodesObserver(
        this,
        function(info) {
          var hasColumns = function hasColumns(node) {
              return (
                node.nodeType === Node.ELEMENT_NODE &&
                "DATA-TABLE-COLUMN" === node.tagName.toUpperCase()
              );
            },
            hasDetails = function hasDetails(node) {
              return (
                node.nodeType === Node.ELEMENT_NODE &&
    ...
    _resetData: function _resetData(dataSource, filter, sortOrder) {
      this.clearSelection();
      this.clearCache();
  ...
  _exports.IronDataTable = IronDataTable;
});
