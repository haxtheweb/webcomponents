...
describe('Instantiation Test', () => {
    it('bootstrap-theme instantiates', async () => {
      const el = await fixture(html` <bootstrap-theme title="test-title"></bootstrap-theme> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('bootstrap-theme passes accessibility negation', async () => {
        const el = await fixture(html`<bootstrap-theme aria-labelledby="bootstrap-theme"></bootstrap-theme>`);
