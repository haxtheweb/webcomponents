...
describe('Instantiation Test', () => {
    it('voice-recorder instantiates', async () => {
      const el = await fixture(html` <voice-recorder title="test-title"></voice-recorder> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('voice-recorder passes accessibility negation', async () => {
        const el = await fixture(html`<voice-recorder aria-labelledby="voice-recorder"></voice-recorder>`);
