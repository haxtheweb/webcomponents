 ...
 */import{html,Polymer}from"./node_modules/@polymer/polymer/polymer-legacy.js";import"./node_modules/@polymer/paper-tabs/paper-tabs.js";import"./node_modules/@polymer/marked-element/marked-element.js";import"./node_modules/@polymer/iron-pages/iron-pages.js";import"./lib/lrn-markdown-editor-editor.js";/**
 * `lrn-markdown-editor`
 ...
 */let LrnMarkdownEditor=Polymer({_template:html`
    <style>
      :host {
        display: block;
      }
...
root._createCookie(cookieName,"true","30")}else if(2!==selected&&!0===root.elReady){/**
       ...
       */root._eraseCookie(cookieName)}},_createCookie:function(name,value,days){var expires="";if(days){var date=new Date;date.setTime(date.getTime()+1e3*(60*(60*(24*days))));expires="; expires="+date.toUTCString()}document.cookie=name+"="+value+expires+"; path=/"},_readCookie:function(name){for(var nameEQ=name+"=",ca=document.cookie.split(";"),i=0,c;i<ca.length;i++){c=ca[i];while(" "==c.charAt(0))c=c.substring(1,c.length);if(0==c.indexOf(nameEQ))return c.substring(nameEQ.length,c.length)}return null},_eraseCookie:function(name){this._createCookie(name,"",-1)},_getCookieName:function(){return"lrnmarkdowneditorsplitview"},ready:function(){var root=this;// tell others we are ready
...
root.selected=2}}});export{LrnMarkdownEditor};