...
import '../src/lrn-markdown-editor.js';
...
describe('Instantiation Test', () => {
    it('lrn-markdown-editor instantiates', async () => {
      const el = await fixture(html` <lrn-markdown-editor title="test-title"></lrn-markdown-editor> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrn-markdown-editor passes accessibility negation', async () => {
        const el = await fixture(html`<lrn-markdown-editor aria-labelledby="lrn-markdown-editor"></lrn-markdown-editor>`);
