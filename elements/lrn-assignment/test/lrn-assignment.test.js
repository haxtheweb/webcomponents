...
describe('Instantiation Test', () => {
    it('lrn-assignment instantiates', async () => {
      const el = await fixture(html` <lrn-assignment title="test-title"></lrn-assignment> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrn-assignment passes accessibility negation', async () => {
        const el = await fixture(html`<lrn-assignment aria-labelledby="lrn-assignment"></lrn-assignment>`);
