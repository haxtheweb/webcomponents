 ...
 */import{html,Polymer}from"./node_modules/@polymer/polymer/polymer-legacy.js";import{dom}from"./node_modules/@polymer/polymer/lib/legacy/polymer.dom.js";/**
 * `media-video`
 * `Video wrapper class`
 *
 * @demo demo/index.html
 */let MediaVideo=Polymer({_template:html`
    <style>
      :host {
        display: block;
      }
...
setTimeout(()=>{this._startIframeVideo(videoSrc)},500)}else{this._stopIframeVideo(videoSrc)}})},_startIframeVideo:function(video){// Start the iframe videos.
...
video.setAttribute("src",videoIframeSrc)},_stopIframeVideo:function(video){video.setAttribute("src","")}});export{MediaVideo};