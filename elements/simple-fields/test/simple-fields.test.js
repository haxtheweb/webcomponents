...
describe('Instantiation Test', () => {
    it('simple-fields instantiates', async () => {
      const el = await fixture(html` <simple-fields title="test-title"></simple-fields> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-fields passes accessibility negation', async () => {
        const el = await fixture(html`<simple-fields aria-labelledby="simple-fields"></simple-fields>`);
