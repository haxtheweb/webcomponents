...
describe('Instantiation Test', () => {
    it('simple-progress instantiates', async () => {
      const el = await fixture(html` <simple-progress title="test-title"></simple-progress> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-progress passes accessibility negation', async () => {
        const el = await fixture(html`<simple-progress aria-labelledby="simple-progress"></simple-progress>`);
