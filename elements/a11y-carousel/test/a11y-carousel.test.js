...
describe('Instantiation Test', () => {
    it('a11y-carousel instantiates', async () => {
      const el = await fixture(html` <a11y-carousel title="test-title"></a11y-carousel> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('a11y-carousel passes accessibility negation', async () => {
        const el = await fixture(html`<a11y-carousel aria-labelledby="a11y-carousel"></a11y-carousel>`);
