...
var VIVE_CONTROLLER_MODEL_OBJ_URL =
  "https://cdn.aframe.io/controllers/vive/vr_controller_vive.obj";
var VIVE_CONTROLLER_MODEL_OBJ_MTL =
...
module.exports.Component = registerComponent("vive-controls", {
  ...
  checkIfControllerPresent: function() {
    var data = this.data;
    var controllerIndex =
      data.hand === "right" ? 0 : data.hand === "left" ? 1 : 2;
  ...
  updateModel: function(buttonName, evtName) {
    ...
    // Update colors.
    color =
      evtName === "up" ? this.data.buttonColor : this.data.buttonHighlightColor;
