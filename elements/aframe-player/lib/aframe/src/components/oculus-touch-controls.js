...
var TOUCH_CONTROLLER_MODEL_OBJ_URL_L =
  TOUCH_CONTROLLER_MODEL_BASE_URL + "left.obj";
var TOUCH_CONTROLLER_MODEL_OBJ_MTL_L =
  TOUCH_CONTROLLER_MODEL_BASE_URL + "left.mtl";
var TOUCH_CONTROLLER_MODEL_OBJ_URL_R =
  TOUCH_CONTROLLER_MODEL_BASE_URL + "right.obj";
var TOUCH_CONTROLLER_MODEL_OBJ_MTL_R =
  TOUCH_CONTROLLER_MODEL_BASE_URL + "right.mtl";
...
module.exports.Component = registerComponent("oculus-touch-controls", {
  ...
  onButtonChanged: function(evt) {
    ...
    if (buttonMeshes) {
      ...
      if (button === "grip" && buttonMeshes.grip) {
        buttonMeshes.grip.rotation.y =
          (this.data.hand === "left" ? -1 : 1) * analogValue * (Math.PI / 60);
      }
    }
  ...
  onModelLoaded: function(evt) {
    ...
    buttonMeshes.grip = controllerObject3D.getObjectByName(
      leftHand
        ? "buttonHand_oculus-touch-controller-left.004"
        : "buttonHand_oculus-touch-controller-right.005"
    );
    buttonMeshes.thumbstick = controllerObject3D.getObjectByName(
      leftHand
        ? "stick_oculus-touch-controller-left.007"
        : "stick_oculus-touch-controller-right.004"
    );
    buttonMeshes.trigger = controllerObject3D.getObjectByName(
      leftHand
        ? "buttonTrigger_oculus-touch-controller-left.005"
        : "buttonTrigger_oculus-touch-controller-right.006"
    );
    buttonMeshes.xbutton = controllerObject3D.getObjectByName(
      "buttonX_oculus-touch-controller-left.002"
    );
    buttonMeshes.abutton = controllerObject3D.getObjectByName(
      "buttonA_oculus-touch-controller-right.002"
    );
    buttonMeshes.ybutton = controllerObject3D.getObjectByName(
      "buttonY_oculus-touch-controller-left.001"
    );
    buttonMeshes.bbutton = controllerObject3D.getObjectByName(
