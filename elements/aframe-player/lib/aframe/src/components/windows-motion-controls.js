...
module.exports.Component = registerComponent("windows-motion-controls", {
  ...
  createControllerModelUrl: function(forceDefault) {
    ...
    var controller = trackedControlsComponent
      ? trackedControlsComponent.controller
      : null;
    var device = "default";
  ...
  lerpAxisTransform: (function() {
    ...
    return function(axis, axisValue) {
      ...
      target.setRotationFromQuaternion(
        quaternion.copy(min.quaternion).slerp(max.quaternion, lerpValue)
      );
  ...
  lerpButtonTransform: (function() {
    ...
    return function(buttonName, buttonValue) {
      ...
      target.setRotationFromQuaternion(
        quaternion.copy(min.quaternion).slerp(max.quaternion, buttonValue)
      );
