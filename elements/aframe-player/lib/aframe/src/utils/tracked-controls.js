 ...
 */
module.exports.checkControllerPresentAndSetup = function(
  component,
  idPrefix,
  queryObject
) {
 ...
 */
function findMatchingController(
  controllers,
  filterIdExact,
  filterIdPrefix,
  filterHand,
  ...
  for (i = 0; i < controllers.length; i++) {
    ...
    if (filterHand && !controller.hand) {
      targetControllerMatch =
        NUM_HANDS * filterControllerIndex +
        (filterHand === DEFAULT_HANDEDNESS ? 0 : 1);
    }
