...
describe('Instantiation Test', () => {
    it('aframe-player instantiates', async () => {
      const el = await fixture(html` <aframe-player title="test-title"></aframe-player> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('aframe-player passes accessibility negation', async () => {
        const el = await fixture(html`<aframe-player aria-labelledby="aframe-player"></aframe-player>`);
