 ...
 */import{html,Polymer}from"./node_modules/@polymer/polymer/polymer-legacy.js";import{pathFromUrl}from"./node_modules/@polymer/polymer/lib/utils/resolve-url.js";import"./node_modules/@lrnwebcomponents/hax-body-behaviors/lib/HAXWiring.js";import"./node_modules/@lrnwebcomponents/schema-behaviors/schema-behaviors.js";import"./node_modules/@lrnwebcomponents/es-global-bridge/es-global-bridge.js";/**
 * `aframe-player`
 ...
 */let AframePlayer=Polymer({_template:html`
  ...
  `,is:"aframe-player",behaviors:[HAXBehaviors.PropertiesBehaviors,SchemaBehaviors.Schema],properties:{/**
...
this.$.scene.removeFullScreenStyles();this.__entity=document.createElement("a-entity");this.__entity.setAttribute("gltf-model","url("+this.source+")");this._positionChanged();this.$.scene.appendChild(this.__entity)},/**
   ...
   */_computePosition:function(x,y,z,width,height){return{x:x,y:y,z:z}},/**
   * When position is updated, inject this into a-frame tag.
   */_positionChanged:function(position){if(this.__entity!==void 0)this.__entity.setAttribute("position",position)}});export{AframePlayer};