...
describe('Instantiation Test', () => {
    it('simple-tooltip instantiates', async () => {
      const el = await fixture(html` <simple-tooltip title="test-title"></simple-tooltip> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-tooltip passes accessibility negation', async () => {
        const el = await fixture(html`<simple-tooltip aria-labelledby="simple-tooltip"></simple-tooltip>`);
