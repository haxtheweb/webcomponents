define(["exports","./node_modules/@polymer/polymer/polymer-legacy.js","./node_modules/@polymer/polymer/lib/legacy/polymer.dom.js","./node_modules/@polymer/polymer/lib/legacy/templatizer-behavior.js","./node_modules/@polymer/polymer/lib/legacy/mutable-data-behavior.js"],function(_exports,_polymerLegacy,_polymerDom,_templatizerBehavior,_mutableDataBehavior){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.GrafittoFilter=void 0;function _templateObject_9db1d1c06a8211e98c1b1363c17c9c30(){var data=babelHelpers.taggedTemplateLiteral(["\n    <div id=\"dom\"><slot></slot></div>\n  "]);_templateObject_9db1d1c06a8211e98c1b1363c17c9c30=function _templateObject_9db1d1c06a8211e98c1b1363c17c9c30(){return data};return data}/**
@license
...
*/var GrafittoFilter=(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_9db1d1c06a8211e98c1b1363c17c9c30()),is:"grafitto-filter",behaviors:[_templatizerBehavior.Templatizer,_mutableDataBehavior.OptionalMutableDataBehavior],properties:{/**
     ...
     */f:{type:Function,notify:!0}},observers:["_populateUserTemplate(filtered)"],/**
   * Filters the items using the f function provided. Recommended when f function is provided
   */filter:function filter(){//This forces _computeFiltered function to do its job :-)
this.where=""},/**
   ...
   */_computeFiltered:function _computeFiltered(items,where,like,caseSensitive){var regex=null;if(caseSensitive){regex=new RegExp(like)}else{regex=new RegExp(like,"i")}var filtered=[];if(this.f){var customFunction=this.f.bind(this);filtered=items.filter(customFunction)}else{//Save a reference to this object
...
if("number"==typeof item){return regex.test(item.toString())}})}return filtered},/**
   ...
   */_populateUserTemplate:function _populateUserTemplate(filtered){// set after template is stamped
...
(0,_polymerDom.dom)(this).appendChild(this.__clone.root)},/**
   ...
   */_decomposeWhere:function _decomposeWhere(where,item){return where.split(".").reduce(function(a,b){return a&&a[b]},item)},/**
   * The `filter` event is fired whenever filtering is done before populating the dom.
   *
   * @event filter
   */_onFilter:function _onFilter(){this.fire("filter")}});_exports.GrafittoFilter=GrafittoFilter});