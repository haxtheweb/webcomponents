...
describe('Instantiation Test', () => {
    it('grafitto-filter instantiates', async () => {
      const el = await fixture(html` <grafitto-filter title="test-title"></grafitto-filter> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('grafitto-filter passes accessibility negation', async () => {
        const el = await fixture(html`<grafitto-filter aria-labelledby="grafitto-filter"></grafitto-filter>`);
