 ...
 */var VideoPlayer=/*#__PURE__*/function(_PolymerElement){babelHelpers.inherits(VideoPlayer,_PolymerElement);function VideoPlayer(){babelHelpers.classCallCheck(this,VideoPlayer);return babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(VideoPlayer).apply(this,arguments))}babelHelpers.createClass(VideoPlayer,[{key:"connectedCallback",/**
   * life cycle, element is afixed to the DOM
   */value:function connectedCallback(){babelHelpers.get(babelHelpers.getPrototypeOf(VideoPlayer.prototype),"connectedCallback",this).call(this);this.HAXWiring=new _HAXWiring.HAXWiring;this.HAXWiring.setup(VideoPlayer.haxProperties,VideoPlayer.tag,this)}/**
   * Get Youtube ID
...
get:function get(){return(0,_polymerElement.html)(_templateObject_a6ea5dd06a8611e999f6f5f8117ac53f())}// haxProperty definition
   ...
   */},{key:"tag",get:function get(){return"video-player"}//behaviors
},{key:"behaviors",get:function get(){return[HAXBehaviors.PropertiesBehaviors,SchemaBehaviors.Schema,A11yBehaviors.A11y,MediaBehaviors.Video]}}]);return VideoPlayer}(_polymerElement.PolymerElement);_exports.VideoPlayer=VideoPlayer;window.customElements.define(VideoPlayer.tag,VideoPlayer)});