...
describe('Instantiation Test', () => {
    it('dynamic-import-registry instantiates', async () => {
      const el = await fixture(html` <dynamic-import-registry title="test-title"></dynamic-import-registry> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('dynamic-import-registry passes accessibility negation', async () => {
        const el = await fixture(html`<dynamic-import-registry aria-labelledby="dynamic-import-registry"></dynamic-import-registry>`);
