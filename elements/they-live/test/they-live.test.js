...
describe('Instantiation Test', () => {
    it('they-live instantiates', async () => {
      const el = await fixture(html` <they-live title="test-title"></they-live> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('they-live passes accessibility negation', async () => {
        const el = await fixture(html`<they-live aria-labelledby="they-live"></they-live>`);
