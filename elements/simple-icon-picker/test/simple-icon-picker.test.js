...
import '../src/simple-icon-picker.js';
...
describe('Instantiation Test', () => {
    it('simple-icon-picker instantiates', async () => {
      const el = await fixture(html` <simple-icon-picker title="test-title"></simple-icon-picker> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-icon-picker passes accessibility negation', async () => {
        const el = await fixture(html`<simple-icon-picker aria-labelledby="simple-icon-picker"></simple-icon-picker>`);
