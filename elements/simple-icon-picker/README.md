...
<script type="module" src="@lrnwebcomponents/simple-icon-picker/simple-icon-picker.js"></script>
/* Alternatives for top of application */
<script type="module">
  import '@lrnwebcomponents/simple-icon-picker/simple-icon-picker.js';
  // imperative form
  import {SimpleIconPicker} from '@lrnwebcomponents/simple-icon-picker';
  // if you don't have a build routine and need to reference directly
  import './node_modules/@lrnwebcomponents/simple-icon-picker/simple-icon-picker.js';
</script>
// via unpkg CDN (good for testing)
<script type="module" src="https://unpkg.com/@lrnwebcomponents/simple-icon-picker/simple-icon-picker.js"></script>
```
