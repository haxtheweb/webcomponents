...
describe('Instantiation Test', () => {
    it('exif-data instantiates', async () => {
      const el = await fixture(html` <exif-data title="test-title"></exif-data> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('exif-data passes accessibility negation', async () => {
        const el = await fixture(html`<exif-data aria-labelledby="exif-data"></exif-data>`);
