 ...
 * @type {array}
 */
var RichTextStyles = [(0, _lit.css)(_templateObject())];
/**
 * RichTextStyles
 *
 * @lit-html
...
var RichTextToolbarStyles = [].concat(RichTextStyles, [(0, _lit.css)(_templateObject2())]);
/**
  ...
  return (
    ...
    function (_RichTextEditorRangeB) {
      ...
      _createClass(_class, [{
        ...
        key: "styles",
        get: function get() {
          return _toConsumableArray(this.richTextEditorButtonStyles);
        }
      }, {
        key: "richTextEditorButtonStyles",
        get: function get() {
      ...
      _createClass(_class, [{
        ...
        key: "getMatchingParent",
        value: function getMatchingParent() {
...
}(RichTextEditorButtonBehaviors(_lit.LitElement));
