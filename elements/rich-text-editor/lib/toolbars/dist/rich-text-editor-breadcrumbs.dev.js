...
function (_RichTextEditorRangeB) {
  _inherits(RichTextEditorBreadcrumbs, _RichTextEditorRangeB);
  ...
  _createClass(RichTextEditorBreadcrumbs, [{
    ...
    value: function render() {
      ...
      return !this.selectionAncestors ? "" : (0, _lit.html)(_templateObject(), this.label, (this.selectionAncestors || []).map(function (ancestor, i) {
        return (0, _lit.html)(_templateObject2(), !!ancestor.selectAll ? "" : "selectnode", _this2.controls, function (e) {
          return _this2._handleClick(ancestor);
        }, ancestor.nodeName.toLowerCase(), i + 1 >= (_this2.selectionAncestors || []).length ? "" : (0, _lit.html)(_templateObject3()));
      }));
    }
  }], [{
    key: "styles",
    get: function get() {
      return [].concat(_toConsumableArray(_richTextEditorButton.RichTextToolbarStyles), [(0, _lit.css)(_templateObject4())]);
    }
  }]);

  return RichTextEditorBreadcrumbs;
}((0, _richTextEditorRangeBehaviors.RichTextEditorRangeBehaviors)(_lit.LitElement));
