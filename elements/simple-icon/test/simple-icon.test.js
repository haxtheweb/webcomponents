...
describe('Instantiation Test', () => {
    it('simple-icon instantiates', async () => {
      const el = await fixture(html` <simple-icon title="test-title"></simple-icon> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-icon passes accessibility negation', async () => {
        const el = await fixture(html`<simple-icon aria-labelledby="simple-icon"></simple-icon>`);
