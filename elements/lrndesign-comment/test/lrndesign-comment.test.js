...
import '../src/lrndesign-comment.js';
...
describe('Instantiation Test', () => {
    it('lrndesign-comment instantiates', async () => {
      const el = await fixture(html` <lrndesign-comment title="test-title"></lrndesign-comment> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrndesign-comment passes accessibility negation', async () => {
        const el = await fixture(html`<lrndesign-comment aria-labelledby="lrndesign-comment"></lrndesign-comment>`);
