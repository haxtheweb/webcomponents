...
describe('Instantiation Test', () => {
    it('simple-modal instantiates', async () => {
      const el = await fixture(html` <simple-modal title="test-title"></simple-modal> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-modal passes accessibility negation', async () => {
        const el = await fixture(html`<simple-modal aria-labelledby="simple-modal"></simple-modal>`);
