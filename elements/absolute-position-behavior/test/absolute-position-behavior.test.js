...
describe('Instantiation Test', () => {
    it('absolute-position-behavior instantiates', async () => {
      const el = await fixture(html` <absolute-position-behavior title="test-title"></absolute-position-behavior> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('absolute-position-behavior passes accessibility negation', async () => {
        const el = await fixture(html`<absolute-position-behavior aria-labelledby="absolute-position-behavior"></absolute-position-behavior>`);
