...
describe('Instantiation Test', () => {
    it('img-view-modal instantiates', async () => {
      const el = await fixture(html` <img-view-modal title="test-title"></img-view-modal> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('img-view-modal passes accessibility negation', async () => {
        const el = await fixture(html`<img-view-modal aria-labelledby="img-view-modal"></img-view-modal>`);
