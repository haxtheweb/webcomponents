...
describe('Instantiation Test', () => {
    it('simple-timer instantiates', async () => {
      const el = await fixture(html` <simple-timer title="test-title"></simple-timer> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-timer passes accessibility negation', async () => {
        const el = await fixture(html`<simple-timer aria-labelledby="simple-timer"></simple-timer>`);
