...
describe('Instantiation Test', () => {
    it('dl-behavior instantiates', async () => {
      const el = await fixture(html` <dl-behavior title="test-title"></dl-behavior> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('dl-behavior passes accessibility negation', async () => {
        const el = await fixture(html`<dl-behavior aria-labelledby="dl-behavior"></dl-behavior>`);
