...
describe('Instantiation Test', () => {
    it('lrndesign-gallerycard instantiates', async () => {
      const el = await fixture(html` <lrndesign-gallerycard title="test-title"></lrndesign-gallerycard> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrndesign-gallerycard passes accessibility negation', async () => {
        const el = await fixture(html`<lrndesign-gallerycard aria-labelledby="lrndesign-gallerycard"></lrndesign-gallerycard>`);
