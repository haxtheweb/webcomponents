...
value:function render(){var _this2=this;return(0,_litElement.html)(_templateObject_acf4aa70326611eaa082394d3b09a3b1(),this._showIcons(this.__hasIcons,this.iconBreakpoint,this.layoutBreakpoint,this.responsiveSize),this.__items.map(function(tab){return(0,_litElement.html)(_templateObject2_acf4aa70326611eaa082394d3b09a3b1(),tab.id,tab.id,function(e){return _this2._handleTab("".concat(tab.id))},tab.id===_this2.activeTab,tab.flag,!tab.flagIcon,tab.flagIcon,tab.label,!tab.flag,tab.flag,!tab.icon,tab.icon,tab.id,tab.label)}))}// haxProperty definition
}],[{key:"styles",//styles function
get:function get(){return[(0,_litElement.css)(_templateObject3_acf4aa70326611eaa082394d3b09a3b1())]}},{key:"haxProperties",get:function get(){return{}}// properties available to the custom element for data binding
