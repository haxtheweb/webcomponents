...
get:function get(){return[(0,_litElement.css)(_templateObject3_c34c835004b311ea8e21ff5e38ed6ab6())]}},{key:"haxProperties",get:function get(){return}// properties available to the custom element for data binding
   ...
   */},{key:"tag",get:function get(){return"a11y-tabs"}}]);function A11yTabs(){var _this;babelHelpers.classCallCheck(this,A11yTabs);_this=babelHelpers.possibleConstructorReturn(this,babelHelpers.getPrototypeOf(A11yTabs).call(this));var callback=function callback(mutationsList,observer){return _this.updateItems()};_this.activeTab=null;_this.disabled=!1;_this.hidden=!1;_this.iconBreakpoint=400;_this.id=null;_this.layoutBreakpoint=600;_this.responsiveSize="xs";_this.vertical=!1;_this.__hasIcons=!1;_this.__items=[];_this.updateItems();_this.__observer=new MutationObserver(callback);_this._breakpointChanged();window.ResponsiveUtility.requestAvailability();_this.__observer.observe(babelHelpers.assertThisInitialized(babelHelpers.assertThisInitialized(_this)),{attributes:!1,childList:!0,subtree:!1});_this.addEventListener("a11y-tab-changed",function(e){return _this.updateItems()});return _this}/**
   ...
   */},{key:"_breakpointChanged",value:function _breakpointChanged(){var root=this,v=-1<this.layoutBreakpoint?this.layoutBreakpoint:0,i=-1<this.iconBreakpoint?this.iconBreakpoint:0,sm=i>v?v:i,md=i>v?i:v,lg=Math.max(i,v)+1,xl=Math.max(i,v)+2;window.dispatchEvent(new CustomEvent("responsive-element-deleted",{bubbles:!0,cancelable:!0,composed:!0,detail:root}));window.dispatchEvent(new CustomEvent("responsive-element",{detail:{element:root,attribute:"responsive-size",relativeToParent:!0,sm:sm,md:md,lg:lg,xl:xl}}));this._setVertical()}/**
   ...
   */},{key:"_showIcons",value:function _showIcons(hasIcons,icon,layout,size){return hasIcons&&-1!==icon&&("xs"===size||icon>layout&&"sm"===size)?"icons-only":""}}]);return A11yTabs}(_litElement.LitElement);_exports.A11yTabs=A11yTabs;window.customElements.define(A11yTabs.tag,A11yTabs)});