...
value:function render(){var _this2=this;return(0,_litElement.html)(_templateObject_d24972501b6f11eaac52414e54d98a89(),this._showIcons(this.__hasIcons,this.iconBreakpoint,this.layoutBreakpoint,this.responsiveSize),this.__items.map(function(tab){return(0,_litElement.html)(_templateObject2_d24972501b6f11eaac52414e54d98a89(),tab.id,tab.id,function(e){return _this2._handleTab("".concat(tab.id))},tab.id===_this2.activeTab,tab.flag,!tab.flagIcon,tab.flagIcon,tab.label,!tab.flag,tab.flag,!tab.icon,tab.icon,tab.id,tab.label)}))}// haxProperty definition
}],[{key:"styles",//styles function
get:function get(){return[(0,_litElement.css)(_templateObject3_d24972501b6f11eaac52414e54d98a89())]}},{key:"haxProperties",get:function get(){return{}}// properties available to the custom element for data binding
