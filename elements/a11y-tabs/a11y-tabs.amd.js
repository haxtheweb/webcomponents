...
value:function render(){var _this2=this;return(0,_litElement.html)(_templateObject_db3720b0fffe11e98cddd171e4daefd9(),this._showIcons(this.__hasIcons,this.iconBreakpoint,this.layoutBreakpoint,this.responsiveSize),this.__items.map(function(tab){return(0,_litElement.html)(_templateObject2_db3720b0fffe11e98cddd171e4daefd9(),tab.id,tab.id,function(e){return _this2._handleTab("".concat(tab.id))},tab.id===_this2.activeTab,tab.flag,!tab.flagIcon,tab.flagIcon,tab.label,!tab.flag,tab.flag,!tab.icon,tab.icon,tab.id,tab.label)}))}// haxProperty definition
}],[{key:"styles",//styles function
get:function get(){return[(0,_litElement.css)(_templateObject3_db3720b0fffe11e98cddd171e4daefd9())]}},{key:"haxProperties",get:function get(){return}// properties available to the custom element for data binding
   ...
   */__observer:{type:Object}};if(babelHelpers.get(babelHelpers.getPrototypeOf(A11yTabs),"properties",this)){props=Object.assign(props,babelHelpers.get(babelHelpers.getPrototypeOf(A11yTabs),"properties",this))}return props}/**
