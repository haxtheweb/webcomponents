...
static get properties(){return{...super.properties,/**
   ...
   */_handleTab(id){this.activeTab=id}/**
   ...
   */_setVertical(){this.vertical=-1===this.layoutBreakpoint||this.iconBreakpoint>this.layoutBreakpoint?"xs"===this.responsiveSize:-1<this.responsiveSize.indexOf("s")}/**
