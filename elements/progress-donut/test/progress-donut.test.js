...
describe('Instantiation Test', () => {
    it('progress-donut instantiates', async () => {
      const el = await fixture(html` <progress-donut title="test-title"></progress-donut> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('progress-donut passes accessibility negation', async () => {
        const el = await fixture(html`<progress-donut aria-labelledby="progress-donut"></progress-donut>`);
