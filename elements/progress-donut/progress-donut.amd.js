 ...
 *  -
 */var ProgressDonut=(0,_polymerLegacy.Polymer)({_template:(0,_polymerLegacy.html)(_templateObject_431607f06a8611e9ab9271de015952cb()),is:"progress-donut",behaviors:[HAXBehaviors.PropertiesBehaviors,SchemaBehaviors.Schema],listeners:{"chartist-render-draw":"_onCreated"},properties:{/**
...
var props={canScale:!0,canPosition:!0,canEditSource:!1,gizmo:{title:"Sample gizmo",description:"The user will be able to see this for selection in a UI.",icon:"av:play-circle-filled",color:"grey",groups:["Video","Media"],handles:[{type:"video",url:"source"}],meta:{author:"Your organization on github"}},settings:{quick:[{property:"title",title:"Title",description:"The title of the element",inputMethod:"textfield",icon:"editor:title"}],configure:[{property:"title",title:"Title",description:"The title of the element",inputMethod:"textfield",icon:"editor:title"}],advanced:[]}};this.setHaxProperties(props)},/**
   ...
   */_getData:function _getData(complete){return{series:complete}},/**
   * Makes chart and returns the chart object.
   */_getImageStyle:function _getImageStyle(size){var offset="22%",diameter="56%";if("xs"===this.size){offset="32%";diameter="36%"}else if("sm"===this.size){offset="26%";diameter="48%"}else if("lg"===this.size){offset="20%";diameter="60%"}else if("xl"===this.size){offset="17%";diameter="66%"}return"left: "+offset+"; top: "+offset+"; width: "+diameter+"; height: "+diameter+";"},/**
   * Makes chart and returns the chart object.
   */_getOptions:function _getOptions(complete,total,size,colors,accentColor,dark){for(var sum=0,i=0;i<complete.length;i++){sum+=parseFloat(complete[i])}return{donut:!0,showLabel:!1,startAngle:0,total:Math.max(sum,total)}},/**
   * Handles chart creation event.
   */_onCreated:function _onCreated(e){this.__chart=e.detail;this.makeChart(this.__chart)},/**
   * Makes chart and returns the chart object.
