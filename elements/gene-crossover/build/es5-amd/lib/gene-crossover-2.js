define([
  ...
  (0, _polymerLegacy.Polymer)({
    _template: (0, _polymerLegacy.html)(
      _templateObject_03a44730f1e611e890b38d7ae81f2a0f()
    ),
    is: "gene-crossover-2",
    properties: {
      tl: { type: Object, value: null },
    ...
    ready: function ready() {
      var root = this,
        ...
        synapsetext = svg.getElementById("synapsetext"),
        setonerightfour = svg.getElementById("setonerightfour"),
        setonerightthree = svg.getElementById("setonerightthree"),
        setonerighttwo = svg.getElementById("setonerighttwo"),
        setonerightone = svg.getElementById("setonerightone"),
        setoneleftfour = svg.getElementById("setoneleftfour"),
        setoneleftthree = svg.getElementById("setoneleftthree"),
        setonelefttwo = svg.getElementById("setonelefttwo"),
        setoneleftone = svg.getElementById("setoneleftone");
      tl.set(
        [
          setoneleftfour,
          setoneleftthree,
      ...
      tl.to([setoneleftone], 0.2, { x: "+=5", alpha: 0 }).to(
        [setonerightone],
        0.2,
        { x: "-=5", alpha: 0 }
      );
      lefttl
        ...
        .to([setoneleftfour], 0.3, { x: "+=10", display: "block" });
      righttl
        .to(
          [setonerighttwo],
          0.1,
        ...
        .to([setonerightfour], 0.3, { x: "-=10", display: "block" });
      this.tl = tl;
      this.lefttl = lefttl;
