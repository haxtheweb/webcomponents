...
describe('Instantiation Test', () => {
    it('simple-concept-network instantiates', async () => {
      const el = await fixture(html` <simple-concept-network title="test-title"></simple-concept-network> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-concept-network passes accessibility negation', async () => {
        const el = await fixture(html`<simple-concept-network aria-labelledby="simple-concept-network"></simple-concept-network>`);
