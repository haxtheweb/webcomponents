...
get:function get(){return[(0,_litElement.css)(_templateObject4_9db0379004b311ea8b8f41b4d0b5fa38())]}},{key:"properties",get:function get(){return babelHelpers.objectSpread({},babelHelpers.get(babelHelpers.getPrototypeOf(SimplePicker),"properties",this),{/**
   * llow a null value?
...
/*attributeChangedCallback(name, oldval, newval) {
   ...
   * @returns {void}
   */},{key:"_goToOption",value:function _goToOption(rownum,colnum){var targetId=(0,_litElement.html)(_templateObject5_9db0379004b311ea8b8f41b4d0b5fa38(),rownum,colnum),target=this.shadowRoot.querySelector("#"+targetId),active=this.shadowRoot.querySelector("#"+this.__activeDesc);if(null!==target){target.tabindex=0;//allow item to be focusable.
