...
#icon {
  ...
  --iron-icon-width: var(--simple-picker-icon-size, var(--simple-picker-option-size, 24px));
  --iron-icon-height: var(--simple-picker-icon-size, var(--simple-picker-option-size, 24px));
