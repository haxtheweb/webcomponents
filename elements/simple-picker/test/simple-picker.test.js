...
describe('Instantiation Test', () => {
    it('simple-picker instantiates', async () => {
      const el = await fixture(html` <simple-picker title="test-title"></simple-picker> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-picker passes accessibility negation', async () => {
        const el = await fixture(html`<simple-picker aria-labelledby="simple-picker"></simple-picker>`);
