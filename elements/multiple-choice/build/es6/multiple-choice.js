...
import { SchemaBehaviors } from "./node_modules/@lrnwebcomponents/schema-behaviors/schema-behaviors.js";
 ...
 */ class MultipleChoice extends SchemaBehaviors(PolymerElement) {
  ...
  constructor() {
    super();
    import("./node_modules/@polymer/iron-icons/iron-icons.js").then(bundle =>
      noop()
    );
    import("./node_modules/@polymer/iron-icon/iron-icon.js").then(bundle =>
      noop()
    );
    import("./node_modules/@polymer/paper-button/paper-button.js").then(
      bundle => noop()
    );
  }
  static get template() {
   ...
   */ connectedCallback() {
    ...
    if (this.singleOption) {
      import("./node_modules/@polymer/paper-radio-group/paper-radio-group.js").then(
        bundle => noop()
      );
      import("./node_modules/@polymer/paper-radio-button/paper-radio-button.js").then(
        bundle => noop()
      );
    } else {
      import("./node_modules/@polymer/paper-checkbox/paper-checkbox.js").then(
        bundle => noop()
      );
    }
