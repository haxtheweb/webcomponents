...
describe('Instantiation Test', () => {
    it('multiple-choice instantiates', async () => {
      const el = await fixture(html` <multiple-choice title="test-title"></multiple-choice> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('multiple-choice passes accessibility negation', async () => {
        const el = await fixture(html`<multiple-choice aria-labelledby="multiple-choice"></multiple-choice>`);
