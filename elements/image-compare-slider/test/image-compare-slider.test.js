...
describe('Instantiation Test', () => {
    it('image-compare-slider instantiates', async () => {
      const el = await fixture(html` <image-compare-slider title="test-title"></image-compare-slider> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('image-compare-slider passes accessibility negation', async () => {
        const el = await fixture(html`<image-compare-slider aria-labelledby="image-compare-slider"></image-compare-slider>`);
