...
describe('Instantiation Test', () => {
    it('outline-player instantiates', async () => {
      const el = await fixture(html` <outline-player title="test-title"></outline-player> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('outline-player passes accessibility negation', async () => {
        const el = await fixture(html`<outline-player aria-labelledby="outline-player"></outline-player>`);
