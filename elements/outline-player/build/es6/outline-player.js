...
import "./node_modules/@lrnwebcomponents/map-menu/map-menu.js";
...
`,
  ...
  properties: {
    ...
    _activeItemContent: { type: String, observer: "_activeItemContentChanged" },
  ...
  _autoLoadChanged: function(newValue) {
    if (typeof newValue !== typeof void 0 && newValue.constructor === Array) {
      if (typeof this.__processedList === typeof void 0) {
        this.__processedList = {};
      }
      for (var i in newValue) {
        let tag = newValue[i].toLowerCase();
        if (typeof this.__processedList[tag] === typeof void 0) {
          try {
  ...
  _activeItemContentChanged: function(newValue) {
  ...
  _outlineChanged: function(newValue, oldValue) {
    if (
      ...
      typeof newValue[0] !== typeof void 0
    ) {
  ...
  _selectedPageChanged: function(newValue) {
    if (typeof newValue !== typeof void 0) {
      if (typeof this._outlineData !== typeof void 0) {
