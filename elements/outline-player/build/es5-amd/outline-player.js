define([
  ...
  function _templateObject_e8b03f70f32e11e8a112c178c7eed5d0() {
    ...
    _templateObject_e8b03f70f32e11e8a112c178c7eed5d0 = function _templateObject_e8b03f70f32e11e8a112c178c7eed5d0() {
      return data;
    };
    return data;
  }
  var OutlinePlayer = (0, _polymerLegacy.Polymer)({
    _template: (0, _polymerLegacy.html)(
      _templateObject_e8b03f70f32e11e8a112c178c7eed5d0()
    ),
    is: "outline-player",
    ...
    _toggleMenu: function _toggleMenu(e) {
      this.$.drawer.toggle();
    ...
    _autoLoadChanged: function _autoLoadChanged(newValue, oldValue) {
      var _this2 = this;
      if (
        ...
        if (
          babelHelpers.typeof(this.__processedList) ===
          ("undefined" === typeof void 0
            ? "undefined"
            : babelHelpers.typeof(void 0))
        ) {
        ...
        var _loop = function _loop() {
          ...
          if (
            babelHelpers.typeof(_this2.__processedList[tag]) ===
            ("undefined" === typeof void 0
              ? "undefined"
              : babelHelpers.typeof(void 0))
          ) {
            try {
              _this2.__processedList[tag] = tag;
              new Promise(function(res, rej) {
                return _require.default(
                  [
                    (0, _resolveUrl.pathFromUrl)(meta.url) +
                      "../".concat(tag, "/").concat(tag, ".js")
                  ],
                  res,
                  rej
                );
    ...
    _activeItemContentChanged: function _activeItemContentChanged(
      newValue,
      oldValue
    ) {
      if (
      ...
      if (
        ...
        babelHelpers.typeof(oldValue) !==
          ("undefined" === typeof void 0
            ...
            : babelHelpers.typeof(void 0)) &&
        newValue.constructor === Array &&
        babelHelpers.typeof(newValue[0]) !==
          ("undefined" === typeof void 0
            ? "undefined"
            : babelHelpers.typeof(void 0))
      ) {
    ...
    _selectedPageChanged: function _selectedPageChanged(newValue, oldValue) {
      var _this3 = this;
      if (
        babelHelpers.typeof(newValue) !==
        ("undefined" === typeof void 0
        ...
        if (
          babelHelpers.typeof(this._outlineData) !==
          ("undefined" === typeof void 0
            ? "undefined"
            : babelHelpers.typeof(void 0))
        ) {
