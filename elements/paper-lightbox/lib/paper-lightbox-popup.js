...
`,
    ...
    _parseAjax: function(e) {
      ...
      return (
        ...
        [].forEach.call(t.children, function(e, t) {
          return n.window.appendChild(e), n.container.classList.add("opening");
        })
      );
    },
    _ajaxResponse: function(e) {
      var t;
      return (
        (t = this), (t.ajaxResponse = e.target.lastResponse), this._createAjax()
      );
    },
    ...
    _createIframe: function() {
      ...
      return (
        ...
        i.indexOf("youtube.com/watch?v=") > -1
    ...
    _removeBackgroundFocus: function() {
      var e, t;
      return (
        (t =
    ...
    _resetBackgroundFocus: function() {
      var e, t;
      return (
        (t =
          "a[href], area[href], input:not([disabled]), button:not([disabled]),select:not([disabled]), textarea:not([disabled]), iframe, object, embed, *[tabindex], *[contenteditable=true]"),
    ...
    _defineCustomEvents: function() {
      var e, t, n;
      return (
        (n = this),
        (e = ["onBeforeOpen", "onAfterOpen", "onBeforeClose", "onAfterClose"]),
        (t = e.length),
        [].forEach.call(e, function(e) {
          return (
            (n[e] = void 0),
