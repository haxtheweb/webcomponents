...
describe('Instantiation Test', () => {
    it('simple-popover instantiates', async () => {
      const el = await fixture(html` <simple-popover title="test-title"></simple-popover> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-popover passes accessibility negation', async () => {
        const el = await fixture(html`<simple-popover aria-labelledby="simple-popover"></simple-popover>`);
