...
describe('Instantiation Test', () => {
    it('simple-search instantiates', async () => {
      const el = await fixture(html` <simple-search title="test-title"></simple-search> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-search passes accessibility negation', async () => {
        const el = await fixture(html`<simple-search aria-labelledby="simple-search"></simple-search>`);
