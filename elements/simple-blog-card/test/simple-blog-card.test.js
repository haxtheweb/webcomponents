...
describe('Instantiation Test', () => {
    it('simple-blog-card instantiates', async () => {
      const el = await fixture(html` <simple-blog-card title="test-title"></simple-blog-card> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-blog-card passes accessibility negation', async () => {
        const el = await fixture(html`<simple-blog-card aria-labelledby="simple-blog-card"></simple-blog-card>`);
