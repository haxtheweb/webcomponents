...
describe('Instantiation Test', () => {
    it('lrndesign-panelcard instantiates', async () => {
      const el = await fixture(html` <lrndesign-panelcard title="test-title"></lrndesign-panelcard> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrndesign-panelcard passes accessibility negation', async () => {
        const el = await fixture(html`<lrndesign-panelcard aria-labelledby="lrndesign-panelcard"></lrndesign-panelcard>`);
