...
describe('Instantiation Test', () => {
    it('responsive-utility instantiates', async () => {
      const el = await fixture(html` <responsive-utility title="test-title"></responsive-utility> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('responsive-utility passes accessibility negation', async () => {
        const el = await fixture(html`<responsive-utility aria-labelledby="responsive-utility"></responsive-utility>`);
