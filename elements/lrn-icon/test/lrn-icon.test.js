...
describe('Instantiation Test', () => {
    it('lrn-icon instantiates', async () => {
      const el = await fixture(html` <lrn-icon title="test-title"></lrn-icon> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrn-icon passes accessibility negation', async () => {
        const el = await fixture(html`<lrn-icon aria-labelledby="lrn-icon"></lrn-icon>`);
