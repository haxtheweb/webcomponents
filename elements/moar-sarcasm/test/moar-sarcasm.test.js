...
describe('Instantiation Test', () => {
    it('moar-sarcasm instantiates', async () => {
      const el = await fixture(html` <moar-sarcasm title="test-title"></moar-sarcasm> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('moar-sarcasm passes accessibility negation', async () => {
        const el = await fixture(html`<moar-sarcasm aria-labelledby="moar-sarcasm"></moar-sarcasm>`);
