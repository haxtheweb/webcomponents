...
describe('Instantiation Test', () => {
    it('dropdown-select instantiates', async () => {
      const el = await fixture(html` <dropdown-select title="test-title"></dropdown-select> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('dropdown-select passes accessibility negation', async () => {
        const el = await fixture(html`<dropdown-select aria-labelledby="dropdown-select"></dropdown-select>`);
