...
describe('Instantiation Test', () => {
    it('punnett-square instantiates', async () => {
      const el = await fixture(html` <punnett-square title="test-title"></punnett-square> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('punnett-square passes accessibility negation', async () => {
        const el = await fixture(html`<punnett-square aria-labelledby="punnett-square"></punnett-square>`);
