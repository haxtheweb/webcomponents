...
describe('Instantiation Test', () => {
    it('hexagon-loader instantiates', async () => {
      const el = await fixture(html` <hexagon-loader title="test-title"></hexagon-loader> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('hexagon-loader passes accessibility negation', async () => {
        const el = await fixture(html`<hexagon-loader aria-labelledby="hexagon-loader"></hexagon-loader>`);
