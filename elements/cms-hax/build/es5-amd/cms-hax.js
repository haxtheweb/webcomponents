define([
  ...
  "use strict";
  function _templateObject_16fe2b50deab11e89ff7fd98eab2361f() {
    ...
    _templateObject_16fe2b50deab11e89ff7fd98eab2361f = function() {
      return data;
    };
    return data;
  }
  (0, _polymerLegacy.Polymer)({
    _template: (0, _polymerLegacy.html)(
      _templateObject_16fe2b50deab11e89ff7fd98eab2361f()
    ),
    is: "cms-hax",
    properties: {
    ...
    attached: function attached() {
      ...
      if (this.syncBody) {
        (0, _polymerDom.dom)(this.$.body).observeNodes(function() {
          var _this = this;
          if (!this.__lock) {
            this.__lock = !0;
            this.fire(
