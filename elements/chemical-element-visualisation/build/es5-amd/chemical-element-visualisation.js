...
], function(_polymerElement, _paperTooltip, _neonAnimation) {
  "use strict";
  function _templateObject_622612e0f1e411e8bedf896f66a00ff7() {
    ...
    _templateObject_622612e0f1e411e8bedf896f66a00ff7 = function _templateObject_622612e0f1e411e8bedf896f66a00ff7() {
      return data;
    };
    return data;
  }
  var ChemicalElementVisualisation = (function(_PolymerElement) {
    ...
    babelHelpers.createClass(ChemicalElementVisualisation, null, [
      {
        ...
        get: function get() {
          return (0, _polymerElement.html)(
            _templateObject_622612e0f1e411e8bedf896f66a00ff7()
          );
        }
      },
      {
    ...
    function ChemicalElementVisualisation() {
      ...
      return babelHelpers.possibleConstructorReturn(
        this,
        babelHelpers.getPrototypeOf(ChemicalElementVisualisation).call(this)
      );
    }
    babelHelpers.createClass(ChemicalElementVisualisation, [
      ...
      },
      {
        ...
        value: function _onElementChange() {
          var _MathPI = Math.PI,
            SIZE = 500,
            dynamicallyAddedElements = this.shadowRoot.querySelectorAll(
              ".added-dynamically"
            );
          ...
          if (this._element) {
            for (
              var electronConfiguration = this._element[
                  "electron-configuration"
                ],
                electronGroup = this.$["electron-group"],
                ringGroup = this.$["ring-group"],
                minimumRadius = SIZE / 6,
                maximumRadius = SIZE / 2,
                i = 0;
              i < electronConfiguration.length;
              i++
            ) {
            ...
            for (
              var outerShell =
                ...
                electronBackgrounds = [],
                _i = 0;
              _i < electronConfiguration.length;
              _i++
            ) {
              for (
                var configuration = electronConfiguration[_i],
                  totalValenceElectrons =
                    ...
                    configuration.f,
                  j = 0;
                j < totalValenceElectrons;
                j++
              ) {
                var electron = document.createElementNS(
                    "http://www.w3.org/2000/svg",
                    "circle"
                  ),
                  electronBackground = document.createElementNS(
                    "http://www.w3.org/2000/svg",
                    "circle"
                  ),
                  ringRadius =
                    minimumRadius +
                    ((_i + 1) * (maximumRadius - minimumRadius)) /
                      (electronConfiguration.length + 1),
                  phaseShift = (_i * _MathPI) / 8,
                  cx =
                    Math.sin(
                      2 * _MathPI * (j / totalValenceElectrons) + phaseShift
                    ) * ringRadius,
                  cy =
                    Math.cos(
                      2 * _MathPI * (j / totalValenceElectrons) + phaseShift
                ...
                if (j >= configuration.s) {
                  if (j >= configuration.p + configuration.s) {
                    if (
                      j >=
                      configuration.d + configuration.p + configuration.s
                    ) {
                      electron.classList.add("f-group-electron");
                      if (
                        1 >= secondOuterShell.d &&
                        3 == electronConfiguration.length - _i
                      )
                      ...
                      if (
                        0 >= outerShell.p &&
                        2 == electronConfiguration.length - _i
                      )
                        electron.setAttribute("opacity", "1");
                    }
                  } else {
