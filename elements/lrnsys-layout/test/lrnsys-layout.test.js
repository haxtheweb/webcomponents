...
describe('Instantiation Test', () => {
    it('lrnsys-layout instantiates', async () => {
      const el = await fixture(html` <lrnsys-layout title="test-title"></lrnsys-layout> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrnsys-layout passes accessibility negation', async () => {
        const el = await fixture(html`<lrnsys-layout aria-labelledby="lrnsys-layout"></lrnsys-layout>`);
