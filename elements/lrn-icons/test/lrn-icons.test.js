...
describe('Instantiation Test', () => {
    it('lrn-icons instantiates', async () => {
      const el = await fixture(html` <lrn-icons title="test-title"></lrn-icons> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrn-icons passes accessibility negation', async () => {
        const el = await fixture(html`<lrn-icons aria-labelledby="lrn-icons"></lrn-icons>`);
