...
describe('Instantiation Test', () => {
    it('figure-label instantiates', async () => {
      const el = await fixture(html` <figure-label title="test-title"></figure-label> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('figure-label passes accessibility negation', async () => {
        const el = await fixture(html`<figure-label aria-labelledby="figure-label"></figure-label>`);
