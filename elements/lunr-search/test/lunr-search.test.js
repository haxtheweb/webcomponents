...
describe('Instantiation Test', () => {
    it('lunr-search instantiates', async () => {
      const el = await fixture(html` <lunr-search title="test-title"></lunr-search> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lunr-search passes accessibility negation', async () => {
        const el = await fixture(html`<lunr-search aria-labelledby="lunr-search"></lunr-search>`);
