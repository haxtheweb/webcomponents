...
describe('Instantiation Test', () => {
    it('beaker-broker instantiates', async () => {
      const el = await fixture(html` <beaker-broker title="test-title"></beaker-broker> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('beaker-broker passes accessibility negation', async () => {
        const el = await fixture(html`<beaker-broker aria-labelledby="beaker-broker"></beaker-broker>`);
