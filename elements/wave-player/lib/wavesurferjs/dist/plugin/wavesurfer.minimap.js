...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["minimap"] = factory();
  else
    (root["WaveSurfer"] = root["WaveSurfer"] || {}),
      (root["WaveSurfer"]["minimap"] = factory());
})(window, function() {
  return /******/ (function(modules) {
    ...
    /******/ /******/ return __webpack_require__(
      (__webpack_require__.s = "./src/plugin/minimap.js")
    );
    /******/
  })(
    /************************************************************************/
            ...
            (function() {
              ...
              function MinimapPlugin(params, ws) {
                ...
                if (typeof params.container === "string") {
                  ...
                  if (!el) {
                    console.warn(
                      "Wavesurfer minimap container ".concat(
                        params.container,
                ...
                this._onAudioprocess = function(currentTime) {
                  _this.drawer.progress(
                    _this.wavesurfer.backend.getPlayedPercents()
                  );
              ...
              _createClass(MinimapPlugin, [
                ...
                },
                {
                  ...
                  value: function renderRegions() {
                    ...
                    var regionElements = this.drawer.wrapper.querySelectorAll(
                      "region"
                    );
                    var i;
                    ...
                    Object.keys(this.regions).forEach(function(id) {
                      ...
                      var width =
                        ...
                        ((region.end - region.start) /
                          _this3.wavesurfer.getDuration());

                      var left =
                        _this3.drawer.width *
                        (region.start / _this3.wavesurfer.getDuration());

                      var regionElement = _this3.util.style(
                ...
                },
                {
                  ...
                  value: function bindMinimapEvents() {
                    ...
                    if (this.params.interact) {
                      this.drawer.wrapper.addEventListener("click", function(
                        event
                      ) {
                        _this4.fireEvent(
                          "click",
                          event,
                          _this4.drawer.handleEvent(event)
                        );
                      });
                    ...
                    if (this.params.showOverview) {
                      ...
                      this.drawer.wrapper.addEventListener(
                        ...
                        function(event) {
                          if (_this4.draggingOverview) {
                            _this4.moveOverviewRegion(
                              event.clientX -
                                _this4.drawer.container.getBoundingClientRect()
                                  .left -
                                relativePositionX
                            );
                          }
                      ...
                      this.drawer.wrapper.addEventListener("mouseup", function(
                        event
                      ) {
                        if (
                  ...
                  value: function moveOverviewRegion(pixels) {
                    if (pixels < 0) {
                      ...
                      this.overviewPosition =
                        this.drawer.width - this.overviewWidth;
                    }
