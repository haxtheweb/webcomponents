...
(function webpackUniversalModuleDefinition(root, factory) {
  if (typeof exports === "object" && typeof module === "object")
    ...
    define("elan", [], factory);
  else if (typeof exports === "object") exports["elan"] = factory();
  else
    (root["WaveSurfer"] = root["WaveSurfer"] || {}),
      (root["WaveSurfer"]["elan"] = factory());
})(window, function() {
  return /******/ (function(modules) {
    ...
    /******/ /******/ return __webpack_require__(
      (__webpack_require__.s = "./src/plugin/elan.js")
    );
    /******/
  })(
    /************************************************************************/
              ...
              _createClass(ElanPlugin, [
                ...
                },
                {
                  ...
                  value: function parseElan(xml) {
                    ...
                    var timeSlots = xml.querySelectorAll(
                        ...
                        return {
                          ...
                          annotations: _map.call(
                            ...
                            function(node) {
                              ...
                              if (
                                _this2.Types.ALIGNABLE_ANNOTATION == annot.type
                              ) {
                      ...
                      tier.annotations.forEach(function(annot) {
                        if (
                          ...
                          annot.reference.type ==
                            _this3.Types.ALIGNABLE_ANNOTATION
                        ) {
