...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["html-init"] = factory();
  else
    (root["WaveSurfer"] = root["WaveSurfer"] || {}),
      (root["WaveSurfer"]["html-init"] = factory());
})(window, function() {
  return /******/ (function(modules) {
    ...
    /******/ /******/ return __webpack_require__(
      (__webpack_require__.s = "./src/html-init.js")
    );
    /******/
  })(
    /************************************************************************/
  ...
  \**************************/
        ...
        /***/ function(module, exports, __webpack_require__) {
          ...
          var _loadScript = _interopRequireDefault(
            __webpack_require__(
              /*! load-script */ "./node_modules/load-script/index.js"
            )
          );
                ...
                var _params = (this.params = WaveSurfer.util.extend(
                  {},
                  {
                    ...
                    loadPlugin: function loadPlugin(name, cb) {
                      var src = _params.pluginCdnTemplate.replace(
                        "[name]",
                        name
                      );
              ...
              _createClass(Init, [
                {
                  ...
                  value: function initAllEls() {
                    ...
                    Array.prototype.forEach.call(this.containers, function(el) {
                      ...
                      var plugins = el.dataset.plugins
                    ...
                    var initialisedPlugins = plugins.map(function(plugin) {
                      ...
                      for (attrName in el.dataset) {
                        ...
                        if (regexResult) {
                          ...
                          var prop = jsonRegex.test(attr)
                            ? JSON.parse(attr)
                            : attr; // this removes the plugin prefix and changes the first letter
