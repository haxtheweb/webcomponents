...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["spectrogram"] = factory();
  else
    (root["WaveSurfer"] = root["WaveSurfer"] || {}),
      (root["WaveSurfer"]["spectrogram"] = factory());
})(window, function() {
  return /******/ (function(modules) {
    ...
    /******/ /******/ return __webpack_require__(
      (__webpack_require__.s = "./src/plugin/spectrogram.js")
    );
    /******/
  })(
    /************************************************************************/
              ...
              _createClass(SpectrogramPlugin, [
                ...
                },
                {
                  ...
                  value: function getFrequencies(callback) {
                    ...
                    var maxSlicesCount = Math.floor(
                      bufferLength / (fftSamples - noverlap)
                    );
                    var currentOffset = 0;

                    while (currentOffset + fftSamples < channelOne.length) {
                      var segment = channelOne.slice(
                        currentOffset,
