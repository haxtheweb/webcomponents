                  ...
                  value: function bindInOut() {
                    ...
                    var onProcess = function onProcess(time) {
                      if (
                        !_this3.firedOut &&
                        _this3.firedIn &&
                        (_this3.start >= Math.round(time * 100) / 100 ||
                          _this3.end <= Math.round(time * 100) / 100)
                      ) {
                    ...
                    (this.drag || this.resize) &&
                      (function() {
                        ...
                        var edgeScroll = function edgeScroll(e) {
                          ...
                          var scrollLeft =
                            _this4.wrapper.scrollLeft +
                            scrollSpeed * scrollDirection;
                          _this4.wrapper.scrollLeft = scrollLeft = Math.min(
                            maxScroll,
                            Math.max(0, scrollLeft)
                          ); // Update time

                          var time =
                            _this4.wavesurfer.drawer.handleEvent(e) * duration;
                          var delta = time - startTime;
                          startTime = time; // Continue dragging or resizing

                          drag
                            ? _this4.onDrag(delta)
                            : _this4.onResize(delta, resize); // Repeat
                        ...
                        var onDown = function onDown(e) {
                          ...
                          startTime =
                            ...
                            duration; // Store for scroll calculations
                        ...
                        var onMove = function onMove(e) {
                          ...
                          if (drag || resize) {
                            ...
                            if (
                              _this4.scroll &&
                              container.clientWidth < _this4.wrapper.scrollWidth
                            ) {
                              if (drag) {
                ...
                },
                {
                  ...
                  value: function enableDragSelection(params) {
                    ...
                    var edgeScroll = function edgeScroll(e) {
                      ...
                      var scrollLeft =
                        _this8.wrapper.scrollLeft +
                        scrollSpeed * scrollDirection;
                      _this8.wrapper.scrollLeft = scrollLeft = Math.min(
                        maxScroll,
                        Math.max(0, scrollLeft)
                      ); // Update range
                    ...
                    var eventDown = function eventDown(e) {
                      ...
                      touchId = e.targetTouches
                        ? e.targetTouches[0].identifier
                        : null; // Store for scroll calculations
                    ...
                    var eventMove = function eventMove(e) {
                      ...
                      if (
                        scroll &&
                        container.clientWidth < _this8.wrapper.scrollWidth
                      ) {
