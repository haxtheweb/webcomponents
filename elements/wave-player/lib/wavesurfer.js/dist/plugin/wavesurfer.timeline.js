...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["timeline"] = factory();
  else
    (root["WaveSurfer"] = root["WaveSurfer"] || {}),
      (root["WaveSurfer"]["timeline"] = factory());
})(window, function() {
  return /******/ (function(modules) {
    ...
    /******/ /******/ return __webpack_require__(
      (__webpack_require__.s = "./src/plugin/timeline.js")
    );
    /******/
  })(
    /************************************************************************/
        ...
        /***/ function(module, exports, __webpack_require__) {
              ...
              _createClass(TimelinePlugin, [
                ...
                },
                {
                  ...
                  value: function updateCanvases() {
                    ...
                    var addCanvas = function addCanvas() {
                      var canvas = _this2.wrapper.appendChild(
                ...
                },
                {
                  ...
                  value: function updateCanvasesPositioning() {
                    ...
                    this.canvases.forEach(function(canvas, i) {
                      ...
                      var canvasWidth =
                        i === canvasesLength - 1
                          ? _this3.drawer.wrapper.scrollWidth -
                            _this3.maxCanvasElementWidth * (canvasesLength - 1)
                          : _this3.maxCanvasElementWidth; // set dimensions and style

                      canvas.width = canvasWidth * _this3.pixelRatio; // on certain pixel ratios the canvas appears cut off at the bottom,
                      // therefore leave 1px extra

                      canvas.height =
                        (_this3.params.height + 1) * _this3.pixelRatio;
                ...
                },
                {
                  ...
                  value: function renderCanvases() {
                    ...
                    var timeInterval = intervalFnOrVal(
                    ...
                    renderPositions(function(i, curSeconds, curPixel) {
                      if (i % primaryLabelInterval === 0) {
                        ...
                        _this4.fillText(
                          ...
                          curPixel +
                            _this4.params.labelPadding * _this4.pixelRatio,
                          height1
                        );
                      }
                  ...
                  value: function fillRect(x, y, width, height) {
                    ...
                    this.canvases.forEach(function(canvas, i) {
                      ...
                      var intersection = {
                        ...
                        x2: Math.min(
                          x + width,
                          i * _this5.maxCanvasWidth + canvas.width
                        ),
                        y2: y + height
                      };
          ...
          var _initialiseProps = function _initialiseProps() {
            ...
            this._onReady = function() {
              ...
              _this6.maxCanvasWidth =
                ws.drawer.maxCanvasWidth || ws.drawer.width;
              _this6.maxCanvasElementWidth =
                ws.drawer.maxCanvasElementWidth ||
                Math.round(_this6.maxCanvasWidth / _this6.pixelRatio);
