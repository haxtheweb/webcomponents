 ...
 */let WavePlayer=Polymer({_template:html`
    <style>
      :host {
        height: 150px;
  ...
  `,is:"wave-player",behaviors:[HAXBehaviors.PropertiesBehaviors,SchemaBehaviors.Schema],properties:{/**
   ...
   */_srcChanged:function(newValue,oldValue){// don't care what it is so long as it's a value
if(typeof newValue!==typeof void 0&&this.__wavesurfer){window.wavesurferobject.load(newValue)}},/**
   * created life cycle
   */created:function(){const name="wavesurfer",basePath=pathFromUrl(decodeURIComponent(import.meta.url)),location=`${basePath}lib/wavesurfer.js/dist/wavesurfer.js`;window.addEventListener(`es-bridge-${name}-loaded`,this._wavesurferLoaded.bind(this));window.ESGlobalBridge.requestAvailability();window.ESGlobalBridge.instance.load(name,location)},/**
   * Attached life cycle
...
let props={canScale:!0,canPosition:!0,canEditSource:!1,gizmo:{title:"Audio player",description:"Audio that is just like spotify.",icon:"av:play-circle-filled",color:"purple",groups:["Video","Media"],handles:[{type:"audio",source:"src",title:"title",caption:"subtitle"}],meta:{author:"LRNWebComponents"}},settings:{quick:[{property:"src",title:"Source",description:"The URL for this video.",inputMethod:"textfield",icon:"link",required:!0,validationType:"url"}],configure:[{property:"src",title:"Source",description:"The URL for this video.",inputMethod:"textfield",icon:"link",required:!0,validationType:"url"},{property:"title",title:"Title",description:"A simple title",inputMethod:"textfield",icon:"av:video-label",required:!1,validationType:"text"}],advanced:[]}};this.setHaxProperties(props)},/**
   * Ready life cycle
   */ready:function(){if("right"===this.lean){this.$.playbutton.style.right="25";this.$.controls.style.right="0"}else{this.$.playbutton.style.left="25";this.$.controls.style.left="0"}if(""===this.name){this.$.albuminfo.classList.add("hidden")}// basic default for coverart if none
...
fillParent:!0,height:100});window.wavesurferobject.init();if(typeof this.src!==typeof void 0){window.wavesurferobject.load(this.src)}window.wavesurferobject.on("ready",()=>{this.$.playbutton.removeAttribute("disabled")});window.wavesurferobject.on("finish",()=>{this.deactivateAnimation()})},/**
   ...
   */togglePlay:function(e){// make sure we have the correct instance loaded before we play
window.wavesurferobject.playPause();var iconType=this.$.playbutton.getAttribute("icon");if("av:play-arrow"===iconType){this.activateAnimation()}else{this.deactivateAnimation()}},/**
   ...
   */toggleMute:function(e){var muteStyle=this.$.mute,iconType=muteStyle.getAttribute("icon");window.wavesurferobject.toggleMute();if("av:volume-up"===iconType){muteStyle.setAttribute("icon","av:volume-off")}else{muteStyle.setAttribute("icon","av:volume-up")}},/**
   * Jumps back 30 seconds
   */throwBack:function(e){window.wavesurferobject.skipBackward(30)}});export{WavePlayer};