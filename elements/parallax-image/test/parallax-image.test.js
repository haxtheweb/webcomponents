...
describe('Instantiation Test', () => {
    it('parallax-image instantiates', async () => {
      const el = await fixture(html` <parallax-image title="test-title"></parallax-image> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('parallax-image passes accessibility negation', async () => {
        const el = await fixture(html`<parallax-image aria-labelledby="parallax-image"></parallax-image>`);
