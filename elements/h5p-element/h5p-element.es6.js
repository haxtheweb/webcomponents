...
<slot></slot>
<div>${this.source}</div>`}// haxProperty definition
...
static get properties(){let props={source:{name:"source",type:"String",value:"",reflectToAttribute:!1,observer:!1}};if(super.properties){props=Object.assign(props,super.properties)}return props}/**
   * Store the tag name to make it easier to obtain directly.
   * @notice function name must be here for tooling to operate correctly
   */tag(){return"h5p-element"}/**
   * Register CSS styles
...
constructor(){super()}/**
   ...
   */connectedCallback(){super.connectedCallback();this.HAXWiring=new HAXWiring;this.HAXWiring.setup(H5PElement.haxProperties,H5PElement.tag,this)}/**
...
}customElements.define("h5p-element",H5PElement);export{H5PElement};