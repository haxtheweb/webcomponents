...
describe('Instantiation Test', () => {
    it('md-extra-icons instantiates', async () => {
      const el = await fixture(html` <md-extra-icons title="test-title"></md-extra-icons> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('md-extra-icons passes accessibility negation', async () => {
        const el = await fixture(html`<md-extra-icons aria-labelledby="md-extra-icons"></md-extra-icons>`);
