...
describe('Instantiation Test', () => {
    it('simple-wc instantiates', async () => {
      const el = await fixture(html` <simple-wc title="test-title"></simple-wc> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-wc passes accessibility negation', async () => {
        const el = await fixture(html`<simple-wc aria-labelledby="simple-wc"></simple-wc>`);
