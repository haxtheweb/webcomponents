...
window.EvoToHax = window.EvoToHax || {};

window.EvoToHax.requestAvailability = () => {
  if (!window.EvoToHax.instance) {
    window.EvoToHax.instance = new EvoToHax();
  }
  this.dispatchEvent(
    new CustomEvent("register-hax-converter", {
      ...
      composed: true,
      cancelable: true,
      detail: window.EvoToHax.instance.convert,
    })
  );

  return window.EvoToHax.instance;
};
export const EvoToHaxConverter = window.EvoToHax.requestAvailability();
