...
export const A11yCollapseGroupStory = () => {
  let props = utils.getElementProperties(A11yCollapseGroup.properties,A11yCollapseGroup.haxProperties);
  return utils.makeElementFromClass(A11yCollapseGroup, 
    {
      id: "group",
      emptyslot: [1, 2, 3].map(i => 
...
export const A11yCollapseStory = () => {
  ...
  [
    ...
    { css: "--a11y-collapse-horizontal-padding", title: "default horizontal-padding" },
    { css: "--a11y-collapse-padding-left" },
    { css: "--a11y-collapse-padding-right" },
    { css: "--a11y-collapse-vertical-padding", title: "default vertical-padding" },
    { css: "--a11y-collapse-padding-top", title: "padding-top" },
    { css: "--a11y-collapse-padding-bottom", title: "padding-bottom" },
    { css: "--a11y-collapse-border-between", title: "vorder between heading and content" },
