...
describe('Instantiation Test', () => {
    it('a11y-collapse instantiates', async () => {
      const el = await fixture(html` <a11y-collapse title="test-title"></a11y-collapse> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('a11y-collapse passes accessibility negation', async () => {
        const el = await fixture(html`<a11y-collapse aria-labelledby="a11y-collapse"></a11y-collapse>`);
