...
describe('Instantiation Test', () => {
    it('paper-avatar instantiates', async () => {
      const el = await fixture(html` <paper-avatar title="test-title"></paper-avatar> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('paper-avatar passes accessibility negation', async () => {
        const el = await fixture(html`<paper-avatar aria-labelledby="paper-avatar"></paper-avatar>`);
