...
describe('Instantiation Test', () => {
    it('lrn-aside instantiates', async () => {
      const el = await fixture(html` <lrn-aside title="test-title"></lrn-aside> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrn-aside passes accessibility negation', async () => {
        const el = await fixture(html`<lrn-aside aria-labelledby="lrn-aside"></lrn-aside>`);
