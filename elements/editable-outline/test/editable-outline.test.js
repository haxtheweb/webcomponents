...
import '../src/editable-outline.js';
...
describe('Instantiation Test', () => {
    it('editable-outline instantiates', async () => {
      const el = await fixture(html` <editable-outline title="test-title"></editable-outline> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('editable-outline passes accessibility negation', async () => {
        const el = await fixture(html`<editable-outline aria-labelledby="editable-outline"></editable-outline>`);
