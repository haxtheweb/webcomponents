...
import '../src/lrndesign-sidenote.js';
...
describe('Instantiation Test', () => {
    it('lrndesign-sidenote instantiates', async () => {
      const el = await fixture(html` <lrndesign-sidenote title="test-title"></lrndesign-sidenote> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrndesign-sidenote passes accessibility negation', async () => {
        const el = await fixture(html`<lrndesign-sidenote aria-labelledby="lrndesign-sidenote"></lrndesign-sidenote>`);
