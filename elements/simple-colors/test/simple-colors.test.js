...
describe('Instantiation Test', () => {
    it('simple-colors instantiates', async () => {
      const el = await fixture(html` <simple-colors title="test-title"></simple-colors> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-colors passes accessibility negation', async () => {
        const el = await fixture(html`<simple-colors aria-labelledby="simple-colors"></simple-colors>`);
