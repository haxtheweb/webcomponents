...
`,
    ...
    if ("object" === typeof children) {
      if (newValue && !oldValue) {
        for (var i in children) {
          if (typeof children[i].tagName !== typeof void 0) {
  ...
  dropEvent: function(e) {
    var normalizedEvent = dom(e),
      local = normalizedEvent.localTarget;
    if (
      typeof this.__activeItem !== typeof void 0 &&
      typeof local !== typeof void 0 &&
  ...
  splitColor: function(value) {
    if ("" != value && typeof this.__hexCodes[value] !== typeof void 0) {
