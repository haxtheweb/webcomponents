...
describe('Instantiation Test', () => {
    it('paper-fab-speed-dial instantiates', async () => {
      const el = await fixture(html` <paper-fab-speed-dial title="test-title"></paper-fab-speed-dial> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('paper-fab-speed-dial passes accessibility negation', async () => {
        const el = await fixture(html`<paper-fab-speed-dial aria-labelledby="paper-fab-speed-dial"></paper-fab-speed-dial>`);
