...
describe('Instantiation Test', () => {
    it('elmsln-studio instantiates', async () => {
      const el = await fixture(html` <elmsln-studio title="test-title"></elmsln-studio> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('elmsln-studio passes accessibility negation', async () => {
        const el = await fixture(html`<elmsln-studio aria-labelledby="elmsln-studio"></elmsln-studio>`);
