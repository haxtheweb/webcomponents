...
export const Studio = () => {
  ...
  console.log(new URL(`//fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;1,100;1,300;1,400;1,500;1,700&display=swap`, import.meta.url))
  return utils.makeElementFromClass(ElmslnStudio, {
    ...
    submissionsSource: new URL(`./demo/data/submissions.json`, import.meta.url)
  },[],["activity","discussion","portfolios","profile","submissions","sourcePath","route","params","query","data"]);
};