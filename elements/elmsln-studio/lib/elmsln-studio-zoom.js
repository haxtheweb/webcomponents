        ...
        [
          ...
          this._buttonGroup(
            [
              this._button(
                ...
                e => this.rotateCCW(this.__img, e),
                "image:rotate-left"
              ),
              this._button(
                "rotate clockwise",
                e => this.rotateCW(this.__img, e),
                "image:rotate-right"
              )
            ],
            true,
          ...
          this._buttonGroup(
            [
              this._button(
                "zoom in",
                e => this.zoomIn(this.__img, e),
                "zoom-in"
              ),
              this._button(
                "zoom out",
                e => this.zoomOut(this.__img, e),
                "zoom-out"
              )
            ],
            true,
          ...
          this._buttonGroup(
            [
              this._button(
                "pan up",
                e => this.panUp(this.__img, e),
                "arrow-upward"
              ),
              this._button(
                "pan down",
                e => this.panDown(this.__img, e),
                "arrow-downward"
              ),
              this._button(
                "pan left",
                e => this.panLeft(this.__img, e),
                "arrow-back"
              ),
              this._button(
                "pan right",
                e => this.panRight(this.__img, e),
                "arrow-forward"
              )
            ],
            true,
