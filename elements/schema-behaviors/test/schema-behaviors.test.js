...
import '../src/schema-behaviors.js';
...
describe('Instantiation Test', () => {
    it('schema-behaviors instantiates', async () => {
      const el = await fixture(html` <schema-behaviors title="test-title"></schema-behaviors> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('schema-behaviors passes accessibility negation', async () => {
        const el = await fixture(html`<schema-behaviors aria-labelledby="schema-behaviors"></schema-behaviors>`);
