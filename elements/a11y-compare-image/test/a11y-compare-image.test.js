...
import '../src/a11y-compare-image.js';
...
describe('Instantiation Test', () => {
    it('a11y-compare-image instantiates', async () => {
      const el = await fixture(html` <a11y-compare-image title="test-title"></a11y-compare-image> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('a11y-compare-image passes accessibility negation', async () => {
        const el = await fixture(html`<a11y-compare-image aria-labelledby="a11y-compare-image"></a11y-compare-image>`);
