 ...
 */let PaperStepper=Polymer({is:"paper-stepper",properties:{selected:{type:Number,notify:!0,value:0},/**
...
_tapPrevious:function(){this.$.selector.selectPrevious()},_tapNext:function(){this.$.selector.selectNext()},/**
   * Returns true if there is a step before the current and if
   * _getDisablePrevious is set to false
   */_getDisablePrevious:function(selected,disablePrevious){return 0<selected&&!disablePrevious},/**
   * Returns true if there is a step after the current and if
   * _getDisableNext is set to false
   */_getDisableNext:function(selected,nrItems,disableNext){return selected<nrItems-1&&!disableNext},/**
   ...
   */_computeProgressValue:function(selected,items){return selected+1},_onItemsChanged:function(e){this._items=this.$.selector.items}});export{PaperStepper};