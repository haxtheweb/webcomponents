define(["exports","./node_modules/@polymer/polymer/polymer-legacy.js"],function(_exports,_polymerLegacy){"use strict";Object.defineProperty(_exports,"__esModule",{value:!0});_exports.PaperStepper=void 0;/**
 ...
 */var PaperStepper=(0,_polymerLegacy.Polymer)({is:"paper-stepper",properties:{selected:{type:Number,notify:!0,value:0},/**
...
_tapPrevious:function _tapPrevious(){this.$.selector.selectPrevious()},_tapNext:function _tapNext(){this.$.selector.selectNext()},/**
   * Returns true if there is a step before the current and if
   * _getDisablePrevious is set to false
   */_getDisablePrevious:function _getDisablePrevious(selected,disablePrevious){return 0<selected&&!disablePrevious},/**
   * Returns true if there is a step after the current and if
   * _getDisableNext is set to false
   */_getDisableNext:function _getDisableNext(selected,nrItems,disableNext){return selected<nrItems-1&&!disableNext},/**
   ...
   */_computeProgressValue:function _computeProgressValue(selected,items){return selected+1},_onItemsChanged:function _onItemsChanged(e){this._items=this.$.selector.items}});_exports.PaperStepper=PaperStepper});