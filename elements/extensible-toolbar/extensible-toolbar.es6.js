 ...
 */import{LitElement,html,css}from"./node_modules/lit-element/lit-element.js";import"./node_modules/@lrnwebcomponents/responsive-utility/responsive-utility.js";/**
 * `extensible-toolbar`
...
static get properties(){return{/**
   ...
   */sticky:{attribute:"sticky",type:"Boolean",reflectToAttribute:!0}}}/**
   * Store the tag name to make it easier to obtain directly.
   * @notice function name must be here for tooling to operate correctly
   */tag(){return"extensible-toolbar"}// life cycle
constructor(){super();this.tag=ExtensibleToolbar.tag;this.collapsed=!1;this.responsiveSize="xs";this.gte="xs sm md lg xl";this.lte="xs";this.sticky=!1}/**
   * Connects to responsive utility.
   * Override if element will inherit parent's responsive size.
   */initResponsive(){let root=this;window.ResponsiveUtility.requestAvailability();window.dispatchEvent(new CustomEvent("responsive-element",{detail:{element:root,attribute:"responsive-size",relativeToParent:!0}}))}/**
   * life cycle, element is afixed to the DOM
   */connectedCallback(){super.connectedCallback();initResponsive()}updated(changedProperties){changedProperties.forEach((oldValue,propName)=>/**
       ...
       */this.dispatchEvent(new CustomEvent(`${propName.replace(/([a-z0-9]|(?=[A-Z]))([A-Z])/g,"$1-$2").toLowerCase()}-changed`,{bubbles:!0,cancelable:!0,composed:!0,detail:this})))}}customElements.define("extensible-toolbar",ExtensibleToolbar);export{ExtensibleToolbar};