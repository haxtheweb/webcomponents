...
describe('Instantiation Test', () => {
    it('topic-heading instantiates', async () => {
      const el = await fixture(html` <topic-heading title="test-title"></topic-heading> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('topic-heading passes accessibility negation', async () => {
        const el = await fixture(html`<topic-heading aria-labelledby="topic-heading"></topic-heading>`);
