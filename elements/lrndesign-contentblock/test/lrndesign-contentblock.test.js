...
describe('Instantiation Test', () => {
    it('lrndesign-contentblock instantiates', async () => {
      const el = await fixture(html` <lrndesign-contentblock title="test-title"></lrndesign-contentblock> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrndesign-contentblock passes accessibility negation', async () => {
        const el = await fixture(html`<lrndesign-contentblock aria-labelledby="lrndesign-contentblock"></lrndesign-contentblock>`);
