...
describe('Instantiation Test', () => {
    it('check-it-out instantiates', async () => {
      const el = await fixture(html` <check-it-out title="test-title"></check-it-out> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('check-it-out passes accessibility negation', async () => {
        const el = await fixture(html`<check-it-out aria-labelledby="check-it-out"></check-it-out>`);
