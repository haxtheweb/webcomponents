define([
  ...
  window.a11yMediaBehaviors.MediaProps = {
    ...
    _hasAttribute: function _hasAttribute(attr) {
      return attr !== void 0 && null !== attr;
    },
    _testAttribute: function _testAttribute(attr, val) {
      return attr === val;
    }
  };
  window.a11yMediaBehaviors.GeneralFunctions = {
    _addResponsiveUtility: function _addResponsiveUtility(data) {
      var root = this,
        data2 =
          data !== void 0
            ? data
  ...
  window.a11yMediaBehaviors.PlayerBehaviors = {
    ...
    _getNoHeight: function _getNoHeight(audioOnly, thumbnailSrc) {
      return audioOnly && (null === thumbnailSrc || thumbnailSrc === void 0);
    },
    _noPlayButton: function _noPlayButton(noHeight, isYoutube) {
      return noHeight || isYoutube;
    },
    _getFullscreenButton: function _getFullscreenButton(disableFullscreen) {
      if (
    ...
    _getCompactControls: function _getCompactControls(responsiveSize) {
      return (
    ...
    _showCustomCaptions: function _showCustomCaptions(
      isYoutube,
      audioOnly,
      cc
    ) {
    ...
    _isFlexLayout: function _isFlexLayout(
      standAlone,
      hideTranscript,
      noHeight,
      stackedLayout
  ...
  window.a11yMediaBehaviors.TranscriptBehaviors = {
    ...
    babelHelpers.defineProperty(_properties, "searchLabel", {
      type: String,
      value: "search transcript"
    }),
    babelHelpers.defineProperty(_properties, "searchIcon", {
      type: String,
      value: "search"
    }),
    babelHelpers.defineProperty(_properties, "searchNextLabel", {
      type: String,
      value: "next result"
    }),
    babelHelpers.defineProperty(_properties, "searchNextIcon", {
      type: String,
      value: "arrow-forward"
    }),
    babelHelpers.defineProperty(_properties, "searchPrevLabel", {
      type: String,
      value: "previous result"
    }),
    babelHelpers.defineProperty(_properties, "searchPrevIcon", {
      type: String,
      value: "arrow-back"
    }),
    babelHelpers.defineProperty(_properties, "skipTranscriptLink", {
      type: String,
