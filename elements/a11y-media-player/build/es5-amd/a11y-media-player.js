define([
  ...
  _screenfullLib,
  _a11yMediaBehaviors,
  _a11yMediaVideoLoader,
  _a11yMediaPlayButton,
  _a11yMediaControls,
  _a11yMediaTranscript,
  _a11yMediaTranscriptControls,
  _a11yMediaUtility,
  _a11yMediaYoutubeUtility
) {
  "use strict";
  Object.defineProperty(_exports, "__esModule", { value: !0 });
  _exports.A11yMediaPlayer = void 0;
  var _Mathmax = Math.max;
  function _templateObject_a53ba420f32c11e8a7ea035229db3ef1() {
    ...
    _templateObject_a53ba420f32c11e8a7ea035229db3ef1 = function _templateObject_a53ba420f32c11e8a7ea035229db3ef1() {
      return data;
    };
    return data;
  }
  var A11yMediaPlayer = (0, _polymerLegacy.Polymer)({
    _template: (0, _polymerLegacy.html)(
      _templateObject_a53ba420f32c11e8a7ea035229db3ef1()
    ),
    ...
    ready: function ready() {
      ...
      root.$.slider.addEventListener("dragging-changed", function(e) {
        _this._toggleSliderSeek(
          root.$.slider.dragging,
          root.$.slider.immediateValue
        );
      });
      root.$.slider.addEventListener("focused-changed", function(e) {
        ...
        var _loop = function _loop(i) {
            if (null !== media.textTracks[i]) {
              var track = media.textTracks[i],
                ...
                getCueData = function getCueData() {
                  track.mode = "hidden";
