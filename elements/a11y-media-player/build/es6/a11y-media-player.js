...
`,
  ...
  ready: function() {
    ...
    if (this.isYoutube) {
      ...
      root.__media.addEventListener("media-loaded", function() {
        ...
        root.__duration = 0 < root.__media.duration ? root.__media.duration : 0;
        root.__status =
  ...
  _youTubeRequest: function() {
    ...
    if (root.__playerAttached && root.__playerReady) {
      let options = { width: "100%", height: "100%", videoId: root.youtubeId },
        ytInit = function() {
  ...
  play: function(e) {
    ...
    if (e === void 0 || e.detail === root.$.playbutton) {
      root.__playProgress = setInterval(() => {
        root.__elapsed =
          0 < root.__media.getCurrentTime() ? root.__media.getCurrentTime() : 0;
        root.__duration = 0 < root.__media.duration ? root.__media.duration : 0;
        root._updateCustomTacks();
        root.__status =
