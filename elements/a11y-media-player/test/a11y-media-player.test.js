...
describe('Instantiation Test', () => {
    it('a11y-media-player instantiates', async () => {
      const el = await fixture(html` <a11y-media-player title="test-title"></a11y-media-player> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('a11y-media-player passes accessibility negation', async () => {
        const el = await fixture(html`<a11y-media-player aria-labelledby="a11y-media-player"></a11y-media-player>`);
