    ...
    utils.getKnobs(fields, 
      {
        ...
        <track label="English" kind="subtitles" srclang="en" src="${new URL(`demo/samples/sintel-de.vtt`, import.meta.url)}" default>
        <track label="Deutsch" kind="subtitles" srclang="de" src="${new URL(`demo/samples/sintel-de.vtt`, import.meta.url)}">
        <track label="Español" kind="subtitles" srclang="es" src="${new URL(`demo/samples/sintel-de.vtt`, import.meta.url)}">
      </video>`
      }
    )
  );
