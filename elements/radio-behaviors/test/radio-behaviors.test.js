...
describe('Instantiation Test', () => {
    it('radio-behaviors instantiates', async () => {
      const el = await fixture(html` <radio-behaviors title="test-title"></radio-behaviors> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('radio-behaviors passes accessibility negation', async () => {
        const el = await fixture(html`<radio-behaviors aria-labelledby="radio-behaviors"></radio-behaviors>`);
