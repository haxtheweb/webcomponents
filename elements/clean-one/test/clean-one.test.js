...
describe('Instantiation Test', () => {
    it('clean-one instantiates', async () => {
      const el = await fixture(html` <clean-one title="test-title"></clean-one> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('clean-one passes accessibility negation', async () => {
        const el = await fixture(html`<clean-one aria-labelledby="clean-one"></clean-one>`);
