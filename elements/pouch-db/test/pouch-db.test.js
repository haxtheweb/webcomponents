...
describe('Instantiation Test', () => {
    it('pouch-db instantiates', async () => {
      const el = await fixture(html` <pouch-db title="test-title"></pouch-db> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('pouch-db passes accessibility negation', async () => {
        const el = await fixture(html`<pouch-db aria-labelledby="pouch-db"></pouch-db>`);
