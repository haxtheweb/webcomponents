...
describe('Instantiation Test', () => {
    it('circle-progress instantiates', async () => {
      const el = await fixture(html` <circle-progress title="test-title"></circle-progress> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('circle-progress passes accessibility negation', async () => {
        const el = await fixture(html`<circle-progress aria-labelledby="circle-progress"></circle-progress>`);
