...
describe('Instantiation Test', () => {
    it('editable-table instantiates', async () => {
      const el = await fixture(html` <editable-table title="test-title"></editable-table> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('editable-table passes accessibility negation', async () => {
        const el = await fixture(html`<editable-table aria-labelledby="editable-table"></editable-table>`);
