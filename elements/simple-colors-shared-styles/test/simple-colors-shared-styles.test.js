...
describe('Instantiation Test', () => {
    it('simple-colors-shared-styles instantiates', async () => {
      const el = await fixture(html` <simple-colors-shared-styles title="test-title"></simple-colors-shared-styles> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-colors-shared-styles passes accessibility negation', async () => {
        const el = await fixture(html`<simple-colors-shared-styles aria-labelledby="simple-colors-shared-styles"></simple-colors-shared-styles>`);
