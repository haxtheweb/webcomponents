...
describe('Instantiation Test', () => {
    it('moment-element instantiates', async () => {
      const el = await fixture(html` <moment-element title="test-title"></moment-element> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('moment-element passes accessibility negation', async () => {
        const el = await fixture(html`<moment-element aria-labelledby="moment-element"></moment-element>`);
