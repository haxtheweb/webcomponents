...
describe('Instantiation Test', () => {
    it('wc-autoload instantiates', async () => {
      const el = await fixture(html` <wc-autoload title="test-title"></wc-autoload> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('wc-autoload passes accessibility negation', async () => {
        const el = await fixture(html`<wc-autoload aria-labelledby="wc-autoload"></wc-autoload>`);
