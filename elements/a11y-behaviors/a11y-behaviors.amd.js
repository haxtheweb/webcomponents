 ...
 */window.A11yBehaviors.A11y={/**
   ...
   */getTextContrastColor:function getTextContrastColor(bgColor){// verify the value is hex value
...
return color},/**
   ...
   */computeTextPropContrast:function computeTextPropContrast(textprop,bgprop){// verify the value is hex value
