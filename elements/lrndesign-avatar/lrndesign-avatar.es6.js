 ...
 */class LrndesignAvatar extends PolymerElement{constructor(){super();import("./node_modules/@lrnwebcomponents/paper-avatar/paper-avatar.js")}static get template(){return html`
    ...
    <paper-avatar
      ...
      jdenticon="[[jdenticon]]"
    ></paper-avatar>`}static get tag(){return"lrndesign-avatar"}_getHexColor(color){let name=color.replace("-text",""),tmp=new SimpleColors;if(tmp.colors[name]){return tmp.colors[name][6]}return"#000000"}static get properties(){return{/**
