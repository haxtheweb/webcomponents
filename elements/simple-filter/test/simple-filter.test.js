...
describe('Instantiation Test', () => {
    it('simple-filter instantiates', async () => {
      const el = await fixture(html` <simple-filter title="test-title"></simple-filter> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('simple-filter passes accessibility negation', async () => {
        const el = await fixture(html`<simple-filter aria-labelledby="simple-filter"></simple-filter>`);
