...
describe('Instantiation Test', () => {
    it('course-design instantiates', async () => {
      const el = await fixture(html` <course-design title="test-title"></course-design> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('course-design passes accessibility negation', async () => {
        const el = await fixture(html`<course-design aria-labelledby="course-design"></course-design>`);
