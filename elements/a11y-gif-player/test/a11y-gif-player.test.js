...
describe('Instantiation Test', () => {
    it('a11y-gif-player instantiates', async () => {
      const el = await fixture(html` <a11y-gif-player title="test-title"></a11y-gif-player> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('a11y-gif-player passes accessibility negation', async () => {
        const el = await fixture(html`<a11y-gif-player aria-labelledby="a11y-gif-player"></a11y-gif-player>`);
