...
const PAGE_AS_DATA_FORMATS = [
  {
    ...
    icon: 'hax:code-json',
    description: 'Reload this page with ?format=json',
  ...
  },
  {
    ...
    description: 'Reload this page with ?format=yaml',
  ...
  },
  {
    ...
    description: 'Reload this page with ?format=md',
  ...
  },
  {
    ...
    icon: 'code',
    description: 'Reload this page with ?format=xml',
