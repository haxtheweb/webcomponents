...
describe('Instantiation Test', () => {
    it('haxcms-elements instantiates', async () => {
      const el = await fixture(html` <haxcms-elements title="test-title"></haxcms-elements> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('haxcms-elements passes accessibility negation', async () => {
        const el = await fixture(html`<haxcms-elements aria-labelledby="haxcms-elements"></haxcms-elements>`);
