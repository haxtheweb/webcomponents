    ...
    <div class="submission-page">
      <paper-card class="submission-page-card ferpa-protect">
        <div class="card-content">
          ...
          <div class="date center">Created: [[date(submission.meta.created)]]</div>
          <div class="date center">Last updated: [[date(submission.meta.changed)]]</div>
          <!-- ----- Text Submission -----  -->
          <template is="dom-if" if="[[submission.attributes.body]]">
           <word-count><marked-element markdown="[[submission.attributes.body]]"></marked-element></word-count>
          </template>
          <!-- ----- Images Submission -----  -->
              ...
              <template is="dom-repeat" items="[[_toArray(submission.attributes.images)]]" as="image">
                <lrnsys-dialog alt="View Image" dynamic-images="">
                  ...
                  <div style="text-align: center;">
                    ...
                    <template is="dom-if" if="[[_isGif(image.url)]]">
                      <iron-image style="width:500px; height:500px; background-color: lightgray;" sizing="contain" class="contain" src="[[image.url]]" preload="" fade=""></iron-image>
                    </template>
                  </div>
