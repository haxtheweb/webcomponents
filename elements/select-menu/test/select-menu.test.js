...
describe('Instantiation Test', () => {
    it('select-menu instantiates', async () => {
      const el = await fixture(html` <select-menu title="test-title"></select-menu> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('select-menu passes accessibility negation', async () => {
        const el = await fixture(html`<select-menu aria-labelledby="select-menu"></select-menu>`);
