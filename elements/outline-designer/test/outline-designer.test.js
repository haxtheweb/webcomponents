...
describe('Instantiation Test', () => {
    it('outline-designer instantiates', async () => {
      const el = await fixture(html` <outline-designer title="test-title"></outline-designer> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('outline-designer passes accessibility negation', async () => {
        const el = await fixture(html`<outline-designer aria-labelledby="outline-designer"></outline-designer>`);
