...
import '../src/mtz-marked-editor.js';
...
describe('Instantiation Test', () => {
    it('mtz-marked-editor instantiates', async () => {
      const el = await fixture(html` <mtz-marked-editor title="test-title"></mtz-marked-editor> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('mtz-marked-editor passes accessibility negation', async () => {
        const el = await fixture(html`<mtz-marked-editor aria-labelledby="mtz-marked-editor"></mtz-marked-editor>`);
