...
describe('Instantiation Test', () => {
    it('lrndesign-paperstack instantiates', async () => {
      const el = await fixture(html` <lrndesign-paperstack title="test-title"></lrndesign-paperstack> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('lrndesign-paperstack passes accessibility negation', async () => {
        const el = await fixture(html`<lrndesign-paperstack aria-labelledby="lrndesign-paperstack"></lrndesign-paperstack>`);
