...
describe('Instantiation Test', () => {
    it('media-image instantiates', async () => {
      const el = await fixture(html` <media-image title="test-title"></media-image> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('media-image passes accessibility negation', async () => {
        const el = await fixture(html`<media-image aria-labelledby="media-image"></media-image>`);
