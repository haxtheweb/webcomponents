 ...
 * @element media-image
 */
class MediaImageProposed extends SchemaBehaviors(DDD) {
  /**
...
customElements.define(MediaImageProposed.tag, MediaImageProposed);
 ...
 */
class MediaImageImageProposed extends SimpleModalHandler(LitElement) {
  /**
   * LitElement constructable styles enhancement
   */
  static get styles() {
  ...
  static get tag() {
    return "media-image-image-proposed";
  }
}
customElements.define(MediaImageImageProposed.tag, MediaImageImageProposed);
 ...
 */
class MediaImageCitationProposed extends LitElement {
  /**
   * LitElement constructable styles enhancement
   */
  static get styles() {
  ...
  static get tag() {
    return "media-image-citation-proposed";
  }
}
customElements.define(MediaImageCitationProposed.tag, MediaImageCitationProposed);
 ...
 */
class MediaImageCaptionProposed extends LitElement {
  /**
   * LitElement constructable styles enhancement
   */
  static get styles() {
  ...
  static get tag() {
    return "media-image-caption-proposed";
  }
}
customElements.define(MediaImageCaptionProposed.tag, MediaImageCaptionProposed);

export { MediaImageProposed };
