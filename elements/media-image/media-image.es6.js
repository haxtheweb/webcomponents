 ...
 */let MediaImage=Polymer({_template:html`
  ...
  `,is:"media-image",behaviors:[HAXBehaviors.PropertiesBehaviors,SchemaBehaviors.Schema],properties:{/**
     * Image source.
   ...
   * Ready.
   */ready:function(){// Establish hax properties if it exist
