...
describe('Instantiation Test', () => {
    it('learn-two-theme instantiates', async () => {
      const el = await fixture(html` <learn-two-theme title="test-title"></learn-two-theme> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('learn-two-theme passes accessibility negation', async () => {
        const el = await fixture(html`<learn-two-theme aria-labelledby="learn-two-theme"></learn-two-theme>`);
