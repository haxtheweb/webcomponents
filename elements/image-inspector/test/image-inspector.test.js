...
describe('Instantiation Test', () => {
    it('image-inspector instantiates', async () => {
      const el = await fixture(html` <image-inspector title="test-title"></image-inspector> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('image-inspector passes accessibility negation', async () => {
        const el = await fixture(html`<image-inspector aria-labelledby="image-inspector"></image-inspector>`);
