...
describe('Instantiation Test', () => {
    it('app-editor-hax instantiates', async () => {
      const el = await fixture(html` <app-editor-hax title="test-title"></app-editor-hax> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('app-editor-hax passes accessibility negation', async () => {
        const el = await fixture(html`<app-editor-hax aria-labelledby="app-editor-hax"></app-editor-hax>`);
