...
*/let AppEditorHax=Polymer({_template:html`
    <style>
      :host {
        display: block;
        font-size: 16px;
...
this.fire("app-editor-hax-import",!0)}});export{AppEditorHax};