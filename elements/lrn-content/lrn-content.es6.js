...
*/class LrnContent extends PolymerElement{static get template(){return html`
    ...
    </div>`}static get tag(){return"lrn-content"}static get properties(){return{title:{type:String,value:!1}}}}window.customElements.define(LrnContent.tag,LrnContent);export{LrnContent};