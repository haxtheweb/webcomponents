  ...
  render() {
    return html`
      ...
      <div class="sorting-controls">
        ...
        <simple-icon-button-lite @click="${this.reset}" class="reset-button" icon="refresh">${this.t.reset}</simple-icon-button-lite>
        <button @click="${this.checkOrder}" class="submit-button" icon="submit">${this.t.submit}</button>
        </div>
      </div>
    `;
  }
