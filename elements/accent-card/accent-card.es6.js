import{html,PolymerElement}from"./node_modules/@polymer/polymer/polymer-element.js";import{HAXWiring}from"./node_modules/@lrnwebcomponents/hax-body-behaviors/lib/HAXWiring.js";import"./node_modules/@lrnwebcomponents/schema-behaviors/schema-behaviors.js";import{SimpleColors}from"./node_modules/@lrnwebcomponents/simple-colors/simple-colors.js";export{AccentCard};class AccentCard extends SimpleColors{static get tag(){return"accent-card"}static get behaviors(){return[SimpleColors]}static get template(){return html`
    ...
    `}static get haxProperties(){return{canEditSource:!1,canPosition:!0,canEditSource:!1,gizmo:{title:"Accent Card",description:"A card with optional accent styling.",icon:"image:crop-landscape",color:"grey",groups:["Media","Text"],handles:[{type:"media",url:"source"},{type:"text",url:"source"}],meta:{author:"nikkimk",owner:"The Pennsylvania State University"}},settings:{quick:[{property:"imageSrc",title:"Image",description:"Optional image",inputMethod:"textfield",icon:"editor:insert-photo"},{property:"accentColor",title:"Accent Color",description:"Accent Color",inputMethod:"colorpicker",icon:"editor:format-color-fill"},{property:"dark",title:"Dark Theme",description:"Use dark theme?",inputMethod:"toggle"},{property:"horizontal",title:"Horizontal",description:"Horizontal orientation?",inputMethod:"toggle"}],configure:[{property:"accentHeading",title:"Heading Accent",description:"Apply the accent color to the heading?",inputMethod:"toggle"},{property:"accentBackground",title:"Background Accent",description:"Apply the accent color to the card background?",inputMethod:"toggle"},{property:"noBorder",title:"No Border Accent",description:"Remove the border accent?",inputMethod:"toggle"},{property:"flat",title:"Flat",description:"Remove the box shadow?",inputMethod:"toggle"}],advanced:[]}}}static get properties(){return{accentBackground:{type:Boolean,value:!1,reflectToAttribute:!0},accentHeading:{type:Boolean,value:!1,reflectToAttribute:!0},flat:{type:Boolean,value:!1,reflectToAttribute:!0},horizontal:{type:Boolean,value:!1,reflectToAttribute:!0},imageSrc:{type:String,value:null},noBorder:{type:Boolean,value:!1,reflectToAttribute:!0},__backgroundStyle:{type:String,computed:"_getBackgroundStyle(imageSrc)"}}}connectedCallback(){super.connectedCallback();this.HAXWiring=new HAXWiring;this.HAXWiring.setHaxProperties(AccentCard.haxProperties,AccentCard.tag,this)}ready(){super.ready()}_hasProp(prop){return prop!==void 0&&null!==prop}_getBackgroundStyle(imageSrc){if(this._hasProp(imageSrc)){return"background-image: url("+imageSrc+");"}else{return"display: none;"}}}window.customElements.define(AccentCard.tag,AccentCard);