...
describe('Instantiation Test', () => {
    it('responsive-grid instantiates', async () => {
      const el = await fixture(html` <responsive-grid title="test-title"></responsive-grid> `);
...
describe('A11y/chai axe tests', () => {
    ...
    it('responsive-grid passes accessibility negation', async () => {
        const el = await fixture(html`<responsive-grid aria-labelledby="responsive-grid"></responsive-grid>`);
