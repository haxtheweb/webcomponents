...
// Thumbnail paths pointing to generated screenshots
...
function generateThumbnailPath(elementName) {
  return `build/es6/node_modules/@haxtheweb/haxcms-elements/lib/theme-screenshots/theme-${elementName}-thumb.png`;
}
