...
export const UsingYourOwnCopy = () => {
  return `
    ...
    <div
      style="border-bottom:1px solid #e0e0e0;background-color:white;padding:20px;margin:0 -8px 40px;}"
    >
      <p>
        Use the
    ...
    <demo-snippet style="${demostyle}">
      <p>
        Add the following to the <tt>&lt;head&gt;</tt> of your page using the
        path where your copy the unbundled script:
      </p>
      <template id="template1">
        <script>
